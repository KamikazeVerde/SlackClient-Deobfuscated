...
/*  43 */       return false;
/*     */     }
/*  45 */     if (checkSufficientDoorsPresentForNewVillager() && this.villagerObj.getIsWillingToTrade(true)) {
/*     */       
...
/*  56 */       return (this.mate.getGrowingAge() == 0 && this.mate.getIsWillingToTrade(true));
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/*  90 */     return (this.matingTimeout >= 0 && checkSufficientDoorsPresentForNewVillager() && this.villagerObj.getGrowingAge() == 0 && this.villagerObj.getIsWillingToTrade(false));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 134 */     this.mate.setIsWillingToTrade(false);
/* 135 */     this.villagerObj.setIsWillingToTrade(false);
