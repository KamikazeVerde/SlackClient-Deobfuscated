...
/*  78 */     super.entityInit();
/*  79 */     this.dataWatcher.addObject(17, Integer.valueOf(0));
/*  80 */     this.dataWatcher.addObject(18, Integer.valueOf(0));
/*  81 */     this.dataWatcher.addObject(19, Integer.valueOf(0));
/*  82 */     this.dataWatcher.addObject(20, Integer.valueOf(0));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 237 */       if (j1 <= 0) {
/*     */         
/* 239 */         this.worldObj.newExplosion((Entity)this, this.posX, this.posY + getEyeHeight(), this.posZ, 7.0F, false, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
...
/*     */         
/* 346 */         if (this.blockBreakCounter == 0 && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
/*     */           
...
/* 644 */     this.dataWatcher.updateObject(17 + targetOffset, Integer.valueOf(newId));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 653 */     return (getHealth() <= getMaxHealth() / 2.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 661 */     return EnumCreatureAttribute.UNDEAD;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
