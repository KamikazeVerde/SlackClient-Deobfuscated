...
/*     */           {
/* 538 */             if (block != Blocks.barrier && block != Blocks.obsidian && block != Blocks.end_stone && block != Blocks.bedrock && block != Blocks.command_block && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
/*     */               
...
/*     */     } 
/*     */     
/* 629 */     boolean flag = this.worldObj.getGameRules().getGameRuleBooleanValue("doMobLoot");
/*     */     
...
/* 680 */     int i = 4;
/* 681 */     double d0 = 12.25D;
/* 682 */     double d1 = 6.25D;
/*     */     
/* 684 */     for (int j = -1; j <= 32; j++) {
/*     */       
/* 686 */       for (int k = -4; k <= 4; k++) {
/*     */         
/* 688 */         for (int l = -4; l <= 4; l++) {
/*     */           
/* 690 */           double d2 = (k * k + l * l);
/*     */           
/* 692 */           if (d2 <= 12.25D) {
/*     */             
/* 694 */             BlockPos blockpos = pos.add(k, j, l);
/*     */             
/* 696 */             if (j < 0) {
/*     */               
/* 698 */               if (d2 <= 6.25D)
/*     */               {
/* 700 */                 this.worldObj.setBlockState(blockpos, Blocks.bedrock.getDefaultState());
/*     */               }
/*     */             }
/* 703 */             else if (j > 0) {
/*     */               
/* 705 */               this.worldObj.setBlockState(blockpos, Blocks.air.getDefaultState());
/*     */             }
/* 707 */             else if (d2 > 6.25D) {
/*     */               
/* 709 */               this.worldObj.setBlockState(blockpos, Blocks.bedrock.getDefaultState());
/*     */             }
/*     */             else {
/*     */               
/* 713 */               this.worldObj.setBlockState(blockpos, Blocks.end_portal.getDefaultState());
/*     */             } 
/*     */           } 
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
/* 720 */     this.worldObj.setBlockState(pos, Blocks.bedrock.getDefaultState());
/* 721 */     this.worldObj.setBlockState(pos.up(), Blocks.bedrock.getDefaultState());
/* 722 */     BlockPos blockpos1 = pos.up(2);
/* 723 */     this.worldObj.setBlockState(blockpos1, Blocks.bedrock.getDefaultState());
/* 724 */     this.worldObj.setBlockState(blockpos1.west(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.EAST));
/* 725 */     this.worldObj.setBlockState(blockpos1.east(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.WEST));
/* 726 */     this.worldObj.setBlockState(blockpos1.north(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.SOUTH));
/* 727 */     this.worldObj.setBlockState(blockpos1.south(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.NORTH));
/* 728 */     this.worldObj.setBlockState(pos.up(3), Blocks.bedrock.getDefaultState());
/* 729 */     this.worldObj.setBlockState(pos.up(4), Blocks.dragon_egg.getDefaultState());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 744 */     return (Entity[])this.dragonPartArray;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 765 */     return "mob.enderdragon.growl";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 773 */     return "mob.enderdragon.hit";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
