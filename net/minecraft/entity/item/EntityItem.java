...
/*     */       
/* 370 */       if (this.delayBeforeCanPickup == 0 && (this.owner == null || 6000 - this.age <= 200 || this.owner.equals(entityIn.getCommandSenderName())) && entityIn.inventory.addItemStackToInventory(itemstack)) {
/*     */         
