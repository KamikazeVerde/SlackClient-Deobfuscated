...
/*  56 */     this.dataWatcher.addObject(17, Integer.valueOf(0));
/*  57 */     this.dataWatcher.addObject(18, Integer.valueOf(1));
/*  58 */     this.dataWatcher.addObject(19, Float.valueOf(0.0F));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         }
/*     */         
/* 136 */         if (!flag && this.worldObj.getGameRules().getGameRuleBooleanValue("doEntityDrops"))
/*     */         {
...
/* 414 */           setDead();
/*     */           
/* 416 */           if (this.worldObj.getGameRules().getGameRuleBooleanValue("doEntityDrops"))
/*     */           {
...
/* 541 */           setDead();
/*     */           
/* 543 */           if (this.worldObj.getGameRules().getGameRuleBooleanValue("doEntityDrops")) {
/*     */             
