...
/*     */     else {
/*     */       
/* 112 */       super.handleHealthUpdate(id);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 241 */     if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("showDeathMessages") && hasCustomName() && getOwner() instanceof net.minecraft.entity.player.EntityPlayerMP)
/*     */     {
/* 243 */       getOwner().addChatMessage(getCombatTracker().getDeathMessage());
/*     */     }
/*     */     
