...
/*     */     {
/* 541 */       livingdata = new GroupData((this.worldObj.rand.nextFloat() < 0.05F), (this.worldObj.rand.nextFloat() < 0.05F));
/*     */     }
/*     */     
...
/*     */     else {
/*     */       
/* 669 */       super.handleHealthUpdate(id);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 763 */     multiplySize(isChild ? 0.5F : 1.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 771 */     boolean flag = (this.zombieWidth > 0.0F && this.zombieHeight > 0.0F);
/* 772 */     this.zombieWidth = width;
/* 773 */     this.zombieHeight = height;
/*     */     
/* 775 */     if (!flag)
/*     */     {
/* 777 */       multiplySize(1.0F);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 788 */     super.setSize(this.zombieWidth * size, this.zombieHeight * size);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 804 */     super.onDeath(cause);
/*     */     
/* 806 */     if (cause.getEntity() instanceof EntityCreeper && !(this instanceof EntityPigZombie) && ((EntityCreeper)cause.getEntity()).getPowered() && ((EntityCreeper)cause.getEntity()).isAIEnabled()) {
/*     */       
/* 808 */       ((EntityCreeper)cause.getEntity()).func_175493_co();
/* 809 */       entityDropItem(new ItemStack(Items.skull, 1, 2), 0.0F);
/*     */     } 
/*     */   }
/*     */   
/*     */   class GroupData
...
/* 820 */       this.isChild = false;
/* 821 */       this.isVillager = false;
/* 822 */       this.isChild = isBaby;
/* 823 */       this.isVillager = isVillagerZombie;
/*     */     }
/*     */   }
/*     */ }
