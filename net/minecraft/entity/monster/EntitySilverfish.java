...
/*     */         int i;
/* 275 */         for (i = 0; i <= 5 && i >= -5; i = (i <= 0) ? (1 - i) : (0 - i)) {
/*     */           int j;
/* 277 */           for (j = 0; j <= 10 && j >= -10; j = (j <= 0) ? (1 - j) : (0 - j)) {
/*     */             int k;
/* 279 */             for (k = 0; k <= 10 && k >= -10; k = (k <= 0) ? (1 - k) : (0 - k)) {
/*     */               
...
/*     */                 
/* 286 */                 if (world.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
/*     */                   
