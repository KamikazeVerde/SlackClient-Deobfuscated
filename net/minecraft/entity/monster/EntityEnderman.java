...
/*  83 */     super.entityInit();
/*  84 */     this.dataWatcher.addObject(16, Short.valueOf((short)0));
...
/*     */     
/*     */     public boolean shouldExecute() {
/* 554 */       return !this.enderman.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing") ? false : ((this.enderman.getHeldBlockState().getBlock().getMaterial() == Material.air) ? false : ((this.enderman.getRNG().nextInt(2000) == 0)));
/*     */     }
/*     */ 
/*     */     
/*     */     public void updateTask() {
...
/*     */     
/*     */     public boolean shouldExecute() {
/* 592 */       return !this.enderman.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing") ? false : ((this.enderman.getHeldBlockState().getBlock().getMaterial() != Material.air) ? false : ((this.enderman.getRNG().nextInt(20) == 0)));
/*     */     }
/*     */ 
/*     */     
/*     */     public void updateTask() {
