...
/*  27 */     String s = null;
/*     */     
/*  29 */     for (KeyBinding keybinding : akeybinding) {
/*     */       
...
/*     */       } 
/*     */       
/*  39 */       int j = mcIn.MCfontRenderer.getStringWidth(I18n.format(keybinding.getKeyDescription(), new Object[0]));
/*     */       
...
/*     */       }
/*     */       
/*  46 */       this.listEntries[i++] = new KeyEntry(keybinding);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*  84 */       this.labelWidth = GuiKeyBindingList.this.mc.MCfontRenderer.getStringWidth(this.labelText);
/*     */     }
/*     */ 
/*     */     
/*     */     public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
/*  89 */       GuiKeyBindingList.this.mc.MCfontRenderer.drawString(this.labelText, GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingList.this.mc.MCfontRenderer.FONT_HEIGHT - 1, 16777215);
/*     */     }
/*     */ 
/*     */     
...
/* 124 */       GuiKeyBindingList.this.mc.MCfontRenderer.drawString(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingList.this.mc.MCfontRenderer.FONT_HEIGHT / 2, 16777215);
...
/*     */       {
/* 136 */         for (KeyBinding keybinding : GuiKeyBindingList.this.mc.gameSettings.keyBindings) {
/*     */           
...
/* 146 */       if (flag) {
/*     */         
/* 148 */         this.btnChangeKeyBinding.displayString = ChatFormatting.WHITE + "> " + ChatFormatting.YELLOW + this.btnChangeKeyBinding.displayString + ChatFormatting.WHITE + " <";
/*     */       }
/* 150 */       else if (flag1) {
/*     */         
/* 152 */         this.btnChangeKeyBinding.displayString = ChatFormatting.RED + this.btnChangeKeyBinding.displayString;
/*     */       } 
/*     */       
