...
/*  85 */                 this.mc.MCfontRenderer.drawStringWithShadow(s, i2, (j2 - 8), 16777215 + (l1 << 24));
...
/*  93 */         if (flag) {
/*     */           
/*  95 */           int k2 = this.mc.MCfontRenderer.FONT_HEIGHT;
...
/* 148 */     List<IChatComponent> list = GuiUtilRenderComponents.func_178908_a(p_146237_1_, i, this.mc.MCfontRenderer, false, false);
...
/* 240 */     if (getChatOpen()) {
/* 241 */       ScaledResolution scaledresolution = new ScaledResolution(this.mc);
/* 242 */       int i = scaledresolution.getScaleFactor();
/* 243 */       float f = getChatScale();
/* 244 */       int j = p_146236_1_ / i - 3;
/* 245 */       int k = p_146236_2_ / i - 27;
/* 246 */       j = MathHelper.floor_float(j / f);
/* 247 */       k = MathHelper.floor_float(k / f);
/*     */       
/* 249 */       if (j >= 0 && k >= 0) {
/* 250 */         int l = Math.min(getLineCount(), this.field_146253_i.size());
/*     */         
/* 252 */         if (j <= MathHelper.floor_float(getChatWidth() / getChatScale()) && k < this.mc.MCfontRenderer.FONT_HEIGHT * l + l) {
/* 253 */           int i1 = k / this.mc.MCfontRenderer.FONT_HEIGHT + this.scrollPos;
/*     */           
/* 255 */           if (i1 >= 0 && i1 < this.field_146253_i.size()) {
/* 256 */             ChatLine chatline = this.field_146253_i.get(i1);
/* 257 */             int j1 = 0;
/*     */             
/* 259 */             for (IChatComponent ichatcomponent : chatline.getChatComponent()) {
/* 260 */               if (ichatcomponent instanceof ChatComponentText) {
/* 261 */                 j1 += this.mc.MCfontRenderer.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)ichatcomponent).getChatComponentText_TextValue(), false));
/*     */                 
/* 263 */                 if (j1 > j) {
/* 264 */                   return ichatcomponent;
/*     */                 }
/*     */               } 
/*     */             } 
/*     */           } 
...
/* 281 */     return this.mc.currentScreen instanceof GuiChat;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 289 */     Iterator<ChatLine> iterator = this.field_146253_i.iterator();
/*     */     
/* 291 */     while (iterator.hasNext()) {
/*     */       
/* 293 */       ChatLine chatline = iterator.next();
/*     */       
/* 295 */       if (chatline.getChatLineID() == p_146242_1_)
/*     */       {
/* 297 */         iterator.remove();
/*     */       }
/*     */     } 
/*     */     
/* 301 */     iterator = this.chatLines.iterator();
/*     */     
/* 303 */     while (iterator.hasNext()) {
/*     */       
/* 305 */       ChatLine chatline1 = iterator.next();
/*     */       
/* 307 */       if (chatline1.getChatLineID() == p_146242_1_) {
/*     */         
/* 309 */         iterator.remove();
/*     */         break;
/*     */       } 
...
/* 317 */     return calculateChatboxWidth(this.mc.gameSettings.chatWidth);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getChatHeight() {
/* 322 */     return calculateChatboxHeight(getChatOpen() ? this.mc.gameSettings.chatHeightFocused : this.mc.gameSettings.chatHeightUnfocused);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 330 */     return this.mc.gameSettings.chatScale;
/*     */   }
/*     */ 
/*     */   
...
/* 335 */     int i = 320;
/* 336 */     int j = 40;
/* 337 */     return MathHelper.floor_float(p_146233_0_ * (i - j) + j);
/*     */   }
/*     */ 
/*     */   
...
/* 342 */     int i = 180;
/* 343 */     int j = 20;
/* 344 */     return MathHelper.floor_float(p_146243_0_ * (i - j) + j);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getLineCount() {
/* 349 */     return getChatHeight() / 9;
/*     */   }
/*     */ }
