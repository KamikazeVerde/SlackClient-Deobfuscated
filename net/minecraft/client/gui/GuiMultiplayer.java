...
/*  22 */   private final OldServerPinger oldServerPinger = new OldServerPinger();
/*     */   
...
/*  60 */       this.savedServerList = new ServerList(this.mc);
/*  61 */       this.savedServerList.loadServerList();
/*  62 */       this.lanServerList = new LanServerDetector.LanServerList();
/*     */ 
/*     */       
/*     */       try {
/*  66 */         this.lanServerDetector = new LanServerDetector.ThreadLanServerFind(this.lanServerList);
/*  67 */         this.lanServerDetector.start();
/*     */       }
/*  69 */       catch (Exception exception) {
/*     */         
/*  71 */         logger.warn("Unable to start LAN server detection: " + exception.getMessage());
/*     */       } 
/*     */       
/*  74 */       this.serverListSelector = new ServerSelectionList(this, this.mc, this.width, this.height, 32, this.height - 64, 36);
/*  75 */       this.serverListSelector.func_148195_a(this.savedServerList);
/*     */     }
/*     */     else {
/*     */       
/*  79 */       this.serverListSelector.setDimensions(this.width, this.height, 32, this.height - 64);
/*     */     } 
/*     */     
/*  82 */     createButtons();
/*     */   }
...
/*  90 */     super.handleMouseInput();
/*  91 */     this.serverListSelector.handleMouseInput();
/*     */   }
/*     */ 
/*     */   
/*     */   public void createButtons() {
/*  96 */     this.buttonList.add(this.btnEditServer = new GuiButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit", new Object[0])));
/*  97 */     this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
/*  98 */     this.buttonList.add(this.btnSelectServer = new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select", new Object[0])));
/*  99 */     this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct", new Object[0])));
/* 100 */     this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add", new Object[0])));
/* 101 */     this.buttonList.add(new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
/* 102 */     this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
/* 103 */     this.buttonList.add(ViaMCP.INSTANCE.getAsyncVersionSlider());
