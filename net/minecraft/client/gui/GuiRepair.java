...
/* 196 */     sendSlotContents(containerToSend, 0, containerToSend.getSlot(0).getStack());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 209 */     if (slotInd == 0) {
/*     */       
/* 211 */       this.nameField.setText((stack == null) ? "" : stack.getDisplayName());
/* 212 */       this.nameField.setEnabled((stack != null));
/*     */       
/* 214 */       if (stack != null)
/*     */       {
/* 216 */         renameItem();
