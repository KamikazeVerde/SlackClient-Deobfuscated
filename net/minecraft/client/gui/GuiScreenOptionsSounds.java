...
/*  39 */     i += 2;
/*     */     
/*  41 */     for (SoundCategory soundcategory : SoundCategory.values()) {
/*     */       
...
/*  81 */     return (f == 0.0F) ? this.field_146508_h : ((int)(f * 100.0F) + "%");
/*     */   }
/*     */   
/*     */   class Button
/*     */     extends GuiButton {
...
/*  96 */       this.displayString = this.field_146152_s + ": " + GuiScreenOptionsSounds.this.getSoundVolume(p_i45024_5_);
...
/* 115 */           this.displayString = this.field_146152_s + ": " + GuiScreenOptionsSounds.this.getSoundVolume(this.field_146153_r);
/*     */         } 
/*     */         
...
/* 132 */         this.displayString = this.field_146152_s + ": " + GuiScreenOptionsSounds.this.getSoundVolume(this.field_146153_r);
