...
/*  39 */     this.field_146597_g.displayString = I18n.format("selectWorld.gameMode", new Object[0]) + " " + I18n.format("selectWorld.gameMode." + this.field_146599_h, new Object[0]);
/*  40 */     this.field_146596_f.displayString = I18n.format("selectWorld.allowCommands", new Object[0]) + " ";
/*     */     
/*  42 */     if (this.field_146600_i) {
/*     */       
/*  44 */       this.field_146596_f.displayString += I18n.format("options.on", new Object[0]);
/*     */     }
/*     */     else {
/*     */       
/*  48 */       this.field_146596_f.displayString += I18n.format("options.off", new Object[0]);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
