...
/* 23 */     this.mc.MCfontRenderer.drawString(I18n.format("lanServer.title", new Object[0]), x + 32 + 3, y + 1, 16777215);
/* 24 */     this.mc.MCfontRenderer.drawString(this.field_148291_b.getServerMotd(), x + 32 + 3, y + 12, 8421504);
/*    */     
/* 26 */     if (this.mc.gameSettings.hideServerAddress) {
/*    */       
/* 28 */       this.mc.MCfontRenderer.drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 3, y + 12 + 11, 3158064);
/*    */     }
/*    */     else {
/*    */       
/* 32 */       this.mc.MCfontRenderer.drawString(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, 3158064);
/*    */     } 
/*    */   }
/*    */ 
/*    */ 
