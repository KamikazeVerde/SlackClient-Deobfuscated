...
/* 152 */     worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
...
/* 173 */     worldrenderer.pos(0.0D, this.height, this.zLevel).tex(0.0D, (f * f2)).func_181666_a(f3, f3, f3, 1.0F).endVertex();
/* 174 */     worldrenderer.pos(i, this.height, this.zLevel).tex((i * f2), (f * f2)).func_181666_a(f3, f3, f3, 1.0F).endVertex();
/* 175 */     worldrenderer.pos(i, 0.0D, this.zLevel).tex((i * f2), (f1 * f2)).func_181666_a(f3, f3, f3, 1.0F).endVertex();
/* 176 */     worldrenderer.pos(0.0D, 0.0D, this.zLevel).tex(0.0D, (f1 * f2)).func_181666_a(f3, f3, f3, 1.0F).endVertex();
...
/* 236 */     worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
/* 237 */     worldrenderer.pos(0.0D, k1, this.zLevel).tex(0.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
/* 238 */     worldrenderer.pos(j1, k1, this.zLevel).tex(1.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
/* 239 */     worldrenderer.pos(j1, 0.0D, this.zLevel).tex(1.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
/* 240 */     worldrenderer.pos(0.0D, 0.0D, this.zLevel).tex(0.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
