...
/*     */     } 
/*     */     
/* 116 */     int i1 = this.mc.MCfontRenderer.getStringWidth(s);
/*     */     
/* 118 */     if (i1 > 157)
/*     */     {
/* 120 */       s = this.mc.MCfontRenderer.trimStringToWidth(s, 157 - this.mc.MCfontRenderer.getStringWidth("...")) + "...";
/*     */     }
/*     */     
/* 123 */     this.mc.MCfontRenderer.drawStringWithShadow(s, (x + 32 + 2), (y + 1), 16777215);
/* 124 */     List<String> list = this.mc.MCfontRenderer.listFormattedStringToWidth(s1, 157);
/*     */     
/* 126 */     for (int l = 0; l < 2 && l < list.size(); l++)
/*     */     {
/* 128 */       this.mc.MCfontRenderer.drawStringWithShadow(list.get(l), (x + 32 + 2), (y + 12 + 10 * l), 8421504);
/*     */     }
/*     */   }
/*     */ 
/*     */   
