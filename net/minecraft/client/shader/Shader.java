...
/*  92 */     worldrenderer.begin(7, DefaultVertexFormats.field_181706_f);
/*  93 */     worldrenderer.pos(0.0D, f1, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
/*  94 */     worldrenderer.pos(f, f1, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
/*  95 */     worldrenderer.pos(f, 0.0D, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
/*  96 */     worldrenderer.pos(0.0D, 0.0D, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
/*  97 */     tessellator.draw();
