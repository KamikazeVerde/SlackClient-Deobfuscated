...
/* 112 */       GL11.glTexImage2D(3553, 0, 32856, this.framebufferTextureWidth, this.framebufferTextureHeight, 0, 6408, 5121, (ByteBuffer)null);
...
/* 253 */       worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
/* 254 */       worldrenderer.pos(0.0D, f1, 0.0D).tex(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).endVertex();
/* 255 */       worldrenderer.pos(f, f1, 0.0D).tex(f2, 0.0D).func_181669_b(255, 255, 255, 255).endVertex();
/* 256 */       worldrenderer.pos(f, 0.0D, 0.0D).tex(f2, f3).func_181669_b(255, 255, 255, 255).endVertex();
/* 257 */       worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, f3).func_181669_b(255, 255, 255, 255).endVertex();
