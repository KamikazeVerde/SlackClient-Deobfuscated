...
/* 180 */     float f = this.particleTextureIndexX / 16.0F;
/* 181 */     float f1 = f + 0.0624375F;
/* 182 */     float f2 = this.particleTextureIndexY / 16.0F;
/* 183 */     float f3 = f2 + 0.0624375F;
/* 184 */     float f4 = 0.1F * this.particleScale;
/*     */     
/* 186 */     if (this.particleIcon != null) {
/*     */       
/* 188 */       f = this.particleIcon.getMinU();
/* 189 */       f1 = this.particleIcon.getMaxU();
/* 190 */       f2 = this.particleIcon.getMinV();
/* 191 */       f3 = this.particleIcon.getMaxV();
/*     */     } 
/*     */     
/* 194 */     float f5 = (float)(this.prevPosX + (this.posX - this.prevPosX) * partialTicks - interpPosX);
/* 195 */     float f6 = (float)(this.prevPosY + (this.posY - this.prevPosY) * partialTicks - interpPosY);
/* 196 */     float f7 = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * partialTicks - interpPosZ);
/* 197 */     int i = getBrightnessForRender(partialTicks);
/* 198 */     int j = i >> 16 & 0xFFFF;
/* 199 */     int k = i & 0xFFFF;
/* 200 */     worldRendererIn.pos((f5 - p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 - p_180434_6_ * f4 - p_180434_8_ * f4)).tex(f1, f3).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/* 201 */     worldRendererIn.pos((f5 - p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 - p_180434_6_ * f4 + p_180434_8_ * f4)).tex(f1, f2).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/* 202 */     worldRendererIn.pos((f5 + p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 + p_180434_6_ * f4 + p_180434_8_ * f4)).tex(f, f2).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/* 203 */     worldRendererIn.pos((f5 + p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 + p_180434_6_ * f4 - p_180434_8_ * f4)).tex(f, f3).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/*     */   }
/*     */ 
/*     */   
...
/* 232 */     int i = getFXLayer();
/*     */     
/* 234 */     if (i == 1) {
/*     */       
/* 236 */       this.particleIcon = icon;
/*     */     }
/*     */     else {
/*     */       
/* 240 */       throw new RuntimeException("Invalid call to Particle.setTex, use coordinate methods");
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 249 */     if (getFXLayer() != 0)
/*     */     {
/* 251 */       throw new RuntimeException("Invalid call to Particle.setMiscTex");
/*     */     }
/*     */ 
/*     */     
/* 255 */     this.particleTextureIndexX = particleTextureIndex % 16;
/* 256 */     this.particleTextureIndexY = particleTextureIndex / 16;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void nextTextureIndexX() {
/* 262 */     this.particleTextureIndexX++;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 275 */     return getClass().getSimpleName() + ", Pos (" + this.posX + "," + this.posY + "," + this.posZ + "), RGBA (" + this.particleRed + "," + this.particleGreen + "," + this.particleBlue + "," + this.particleAlpha + "), Age " + this.particleAge;
/*     */   }
/*     */ }
