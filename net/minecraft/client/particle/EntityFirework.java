...
/*  46 */       int k = i & 0xFFFF;
/*  47 */       worldRendererIn.pos((f5 - p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 - p_180434_6_ * f4 - p_180434_8_ * f4)).tex(0.5D, 0.375D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/*  48 */       worldRendererIn.pos((f5 - p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 - p_180434_6_ * f4 + p_180434_8_ * f4)).tex(0.5D, 0.125D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/*  49 */       worldRendererIn.pos((f5 + p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 + p_180434_6_ * f4 + p_180434_8_ * f4)).tex(0.25D, 0.125D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/*  50 */       worldRendererIn.pos((f5 + p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 + p_180434_6_ * f4 - p_180434_8_ * f4)).tex(0.25D, 0.375D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
/*     */     }
/*     */   }
/*     */   
...
/*     */           double d8;
/* 394 */           for (d8 = 0.25D; d8 <= 1.0D; d8 += 0.25D) {
/*     */             
...
/* 399 */             d9 *= Math.cos(d3);
/*     */             double d12;
/* 401 */             for (d12 = -1.0D; d12 <= 1.0D; d12 += 2.0D)
/*     */             {
