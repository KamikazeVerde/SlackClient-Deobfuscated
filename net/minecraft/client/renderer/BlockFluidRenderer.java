...
/* 137 */           float f25 = f4 * f1;
/* 138 */           float f26 = f4 * f2;
/* 139 */           worldRendererIn.pos(d0 + 0.0D, d1 + f7, d2 + 0.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f13, f17).func_181671_a(l2, i3).endVertex();
/* 140 */           worldRendererIn.pos(d0 + 0.0D, d1 + f8, d2 + 1.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f14, f18).func_181671_a(l2, i3).endVertex();
/* 141 */           worldRendererIn.pos(d0 + 1.0D, d1 + f9, d2 + 1.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f15, f19).func_181671_a(l2, i3).endVertex();
/* 142 */           worldRendererIn.pos(d0 + 1.0D, d1 + f10, d2 + 0.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f16, f20).func_181671_a(l2, i3).endVertex();
/*     */           
/* 144 */           if (blockliquid.func_176364_g(blockAccess, blockPosIn.up())) {
/*     */             
/* 146 */             worldRendererIn.pos(d0 + 0.0D, d1 + f7, d2 + 0.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f13, f17).func_181671_a(l2, i3).endVertex();
/* 147 */             worldRendererIn.pos(d0 + 1.0D, d1 + f10, d2 + 0.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f16, f20).func_181671_a(l2, i3).endVertex();
/* 148 */             worldRendererIn.pos(d0 + 1.0D, d1 + f9, d2 + 1.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f15, f19).func_181671_a(l2, i3).endVertex();
/* 149 */             worldRendererIn.pos(d0 + 0.0D, d1 + f8, d2 + 1.0D).func_181666_a(f24, f25, f26, 1.0F).tex(f14, f18).func_181671_a(l2, i3).endVertex();
/*     */           } 
/*     */         } 
/*     */         
/* 153 */         if (flag1) {
...
/* 164 */           worldRendererIn.pos(d0, d1, d2 + 1.0D).func_181666_a(f * f41, f1 * f41, f2 * f41, 1.0F).tex(f35, f38).func_181671_a(i2, j2).endVertex();
/* 165 */           worldRendererIn.pos(d0, d1, d2).func_181666_a(f * f41, f1 * f41, f2 * f41, 1.0F).tex(f35, f37).func_181671_a(i2, j2).endVertex();
/* 166 */           worldRendererIn.pos(d0 + 1.0D, d1, d2).func_181666_a(f * f41, f1 * f41, f2 * f41, 1.0F).tex(f36, f37).func_181671_a(i2, j2).endVertex();
/* 167 */           worldRendererIn.pos(d0 + 1.0D, d1, d2 + 1.0D).func_181666_a(f * f41, f1 * f41, f2 * f41, 1.0F).tex(f36, f38).func_181671_a(i2, j2).endVertex();
/* 168 */           bool1 = true;
/*     */         } 
/*     */         
...
/* 259 */             worldRendererIn.pos(d3, d1 + f39, d4).func_181666_a(f32, f33, f34, 1.0F).tex(f42, f28).func_181671_a(k, l).endVertex();
/* 260 */             worldRendererIn.pos(d5, d1 + f40, d6).func_181666_a(f32, f33, f34, 1.0F).tex(f27, f29).func_181671_a(k, l).endVertex();
/* 261 */             worldRendererIn.pos(d5, d1 + 0.0D, d6).func_181666_a(f32, f33, f34, 1.0F).tex(f27, f30).func_181671_a(k, l).endVertex();
/* 262 */             worldRendererIn.pos(d3, d1 + 0.0D, d4).func_181666_a(f32, f33, f34, 1.0F).tex(f42, f30).func_181671_a(k, l).endVertex();
/* 263 */             worldRendererIn.pos(d3, d1 + 0.0D, d4).func_181666_a(f32, f33, f34, 1.0F).tex(f42, f30).func_181671_a(k, l).endVertex();
/* 264 */             worldRendererIn.pos(d5, d1 + 0.0D, d6).func_181666_a(f32, f33, f34, 1.0F).tex(f27, f30).func_181671_a(k, l).endVertex();
/* 265 */             worldRendererIn.pos(d5, d1 + f40, d6).func_181666_a(f32, f33, f34, 1.0F).tex(f27, f29).func_181671_a(k, l).endVertex();
/* 266 */             worldRendererIn.pos(d3, d1 + f39, d4).func_181666_a(f32, f33, f34, 1.0F).tex(f42, f28).func_181671_a(k, l).endVertex();
/*     */           } 
/*     */         } 
/*     */         
/* 270 */         worldRendererIn.setSprite(null);
