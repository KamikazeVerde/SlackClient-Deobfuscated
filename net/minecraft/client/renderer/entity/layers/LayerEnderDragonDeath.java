...
/* 49 */         worldrenderer.begin(6, DefaultVertexFormats.field_181706_f);
/* 50 */         worldrenderer.pos(0.0D, 0.0D, 0.0D).func_181669_b(255, 255, 255, (int)(255.0F * (1.0F - f1))).endVertex();
/* 51 */         worldrenderer.pos(-0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
/* 52 */         worldrenderer.pos(0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
/* 53 */         worldrenderer.pos(0.0D, f2, (1.0F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
/* 54 */         worldrenderer.pos(-0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
/* 55 */         tessellator.draw();
/*    */       } 
/*    */       
