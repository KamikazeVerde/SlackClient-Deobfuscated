...
/* 73 */     return entity.isVillager() ? zombieVillagerTextures : zombieTextures;
/*    */   }
/*    */ 
/*    */   
/*    */   private void func_82427_a(EntityZombie zombie) {
/* 78 */     if (zombie.isVillager()) {
/*    */       
/* 80 */       this.mainModel = (ModelBase)this.zombieVillagerModel;
/* 81 */       this.layerRenderers = this.field_177121_n;
/*    */     }
/*    */     else {
/*    */       
/* 85 */       this.mainModel = (ModelBase)this.field_82434_o;
/* 86 */       this.layerRenderers = this.field_177122_o;
/*    */     } 
/*    */     
/* 89 */     this.modelBipedMain = (ModelBiped)this.mainModel;
/*    */   }
/*    */ 
/*    */   
/*    */   protected void rotateCorpse(EntityZombie bat, float p_77043_2_, float p_77043_3_, float partialTicks) {
/* 94 */     if (bat.isConverting())
/*    */     {
/* 96 */       p_77043_3_ += (float)(Math.cos(bat.ticksExisted * 3.25D) * Math.PI * 0.25D);
/*    */     }
/*    */     
/* 99 */     super.rotateCorpse(bat, p_77043_2_, p_77043_3_, partialTicks);
/*    */   }
/*    */ }
