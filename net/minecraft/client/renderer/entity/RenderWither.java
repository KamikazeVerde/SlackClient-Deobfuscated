...
/* 31 */     BossStatus.setBossStatus((IBossDisplayData)entity, true);
...
/* 40 */     int i = entity.getInvulTime();
/* 41 */     return (i > 0 && (i > 80 || i / 5 % 2 != 1)) ? invulnerableWitherTextures : witherTextures;
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 50 */     float f = 2.0F;
/* 51 */     int i = entitylivingbaseIn.getInvulTime();
/*    */     
/* 53 */     if (i > 0)
/*    */     {
/* 55 */       f -= (i - partialTickTime) / 220.0F * 0.5F;
/*    */     }
/*    */     
/* 58 */     GlStateManager.scale(f, f, f);
/*    */   }
/*    */ }
