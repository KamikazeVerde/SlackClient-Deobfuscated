...
/*  31 */   private static int[] dataArray = new int[4194304];
/*     */ 
/*     */   
...
/*     */               
/*  90 */               int k1 = 2 * (i1 + j1 * l);
/*  91 */               aint2[i1 + j1 * j] = blendColors(aint1[k1 + 0], aint1[k1 + 1], aint1[k1 + 0 + l], aint1[k1 + 1 + l], flag);
/*     */             } 
/*     */           } 
/*     */           
/*  95 */           aint[l1] = aint2;
...
/*     */     {
/* 180 */       GL11.glTexImage2D(3553, i, 6408, p_180600_2_ >> i, p_180600_3_ >> i, 0, 32993, 33639, (ByteBuffer)null);
/*     */     }
/*     */   }
/*     */ 
/*     */   
