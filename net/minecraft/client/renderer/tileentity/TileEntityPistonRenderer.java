...
/*    */         
/* 56 */         iblockstate = iblockstate.withProperty((IProperty)BlockPistonExtension.SHORT, Boolean.TRUE);
...
/* 66 */         iblockstate.withProperty((IProperty)BlockPistonBase.EXTENDED, Boolean.TRUE);
