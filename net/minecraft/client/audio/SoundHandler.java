...
/* 132 */       final String s1 = s.contains(":") ? resourcelocation.getResourceDomain() : location.getResourceDomain();
/*     */ 
/*     */       
...
/*     */           } 
/*     */           
/* 160 */           isoundeventaccessor = new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, soundlist$soundentry.getSoundEntryPitch(), soundlist$soundentry.getSoundEntryVolume(), soundlist$soundentry.isStreaming()), soundlist$soundentry.getSoundEntryWeight());
/*     */           break;
/*     */         
/*     */         case SOUND_EVENT:
/* 164 */           isoundeventaccessor = new ISoundEventAccessor<SoundPoolEntry>()
/*     */             {
/* 166 */               final ResourceLocation field_148726_a = new ResourceLocation(s1, soundlist$soundentry.getSoundEntryName());
/*     */               
...
/*     */       } 
/*     */       
/* 184 */       soundeventaccessorcomposite.addSoundToEventPool(isoundeventaccessor);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
