...
/* 411 */     if (pos.getY() > 64) {
/*     */       
/* 413 */       float f = (float)(temperatureNoise.func_151601_a(pos.getX() * 1.0D / 8.0D, pos.getZ() * 1.0D / 8.0D) * 4.0D);
/* 414 */       return this.temperature - (f + pos.getY() - 64.0F) * 0.05F / 30.0F;
/*     */     } 
/*     */ 
/*     */     
/* 418 */     return this.temperature;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void decorate(World worldIn, Random rand, BlockPos pos) {
/* 424 */     this.theBiomeDecorator.decorate(worldIn, rand, this, pos);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getGrassColorAtPos(BlockPos pos) {
/* 429 */     double d0 = MathHelper.clamp_float(getFloatTemperature(pos), 0.0F, 1.0F);
/* 430 */     double d1 = MathHelper.clamp_float(getFloatRainfall(), 0.0F, 1.0F);
/* 431 */     return ColorizerGrass.getGrassColor(d0, d1);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getFoliageColorAtPos(BlockPos pos) {
/* 436 */     double d0 = MathHelper.clamp_float(getFloatTemperature(pos), 0.0F, 1.0F);
/* 437 */     double d1 = MathHelper.clamp_float(getFloatRainfall(), 0.0F, 1.0F);
/* 438 */     return ColorizerFoliage.getFoliageColor(d0, d1);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isSnowyBiome() {
/* 443 */     return this.enableSnow;
/*     */   }
/*     */ 
/*     */   
/*     */   public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
/* 448 */     generateBiomeTerrain(worldIn, rand, chunkPrimerIn, p_180622_4_, p_180622_5_, p_180622_6_);
/*     */   }
/*     */ 
/*     */   
...
/* 453 */     int i = worldIn.func_181545_F();
/* 454 */     IBlockState iblockstate = this.topBlock;
/* 455 */     IBlockState iblockstate1 = this.fillerBlock;
/* 456 */     int j = -1;
/* 457 */     int k = (int)(p_180628_6_ / 3.0D + 3.0D + rand.nextDouble() * 0.25D);
/* 458 */     int l = p_180628_4_ & 0xF;
/* 459 */     int i1 = p_180628_5_ & 0xF;
/* 460 */     BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos();
/*     */     
/* 462 */     for (int j1 = 255; j1 >= 0; j1--) {
/*     */       
/* 464 */       if (j1 <= rand.nextInt(5)) {
/*     */         
/* 466 */         chunkPrimerIn.setBlockState(i1, j1, l, Blocks.bedrock.getDefaultState());
/*     */       }
/*     */       else {
/*     */         
/* 470 */         IBlockState iblockstate2 = chunkPrimerIn.getBlockState(i1, j1, l);
/*     */         
/* 472 */         if (iblockstate2.getBlock().getMaterial() == Material.air) {
/*     */           
/* 474 */           j = -1;
/*     */         }
/* 476 */         else if (iblockstate2.getBlock() == Blocks.stone) {
/*     */           
/* 478 */           if (j == -1) {
/*     */             
/* 480 */             if (k <= 0) {
/*     */               
/* 482 */               iblockstate = null;
/* 483 */               iblockstate1 = Blocks.stone.getDefaultState();
/*     */             }
/* 485 */             else if (j1 >= i - 4 && j1 <= i + 1) {
/*     */               
/* 487 */               iblockstate = this.topBlock;
/* 488 */               iblockstate1 = this.fillerBlock;
/*     */             } 
/*     */             
/* 491 */             if (j1 < i && (iblockstate == null || iblockstate.getBlock().getMaterial() == Material.air))
/*     */             {
/* 493 */               if (getFloatTemperature((BlockPos)blockpos$mutableblockpos.func_181079_c(p_180628_4_, j1, p_180628_5_)) < 0.15F) {
/*     */                 
/* 495 */                 iblockstate = Blocks.ice.getDefaultState();
/*     */               }
/*     */               else {
/*     */                 
/* 499 */                 iblockstate = Blocks.water.getDefaultState();
/*     */               } 
/*     */             }
/*     */             
/* 503 */             j = k;
...
/* 505 */             if (j1 >= i - 1)
/*     */             {
/* 507 */               chunkPrimerIn.setBlockState(i1, j1, l, iblockstate);
/*     */             }
/* 509 */             else if (j1 < i - 7 - k)
/*     */             {
/* 511 */               iblockstate = null;
/* 512 */               iblockstate1 = Blocks.stone.getDefaultState();
/* 513 */               chunkPrimerIn.setBlockState(i1, j1, l, Blocks.gravel.getDefaultState());
/*     */             }
/*     */             else
/*     */             {
/* 517 */               chunkPrimerIn.setBlockState(i1, j1, l, iblockstate1);
/*     */             }
/*     */           
/* 520 */           } else if (j > 0) {
/*     */             
/* 522 */             j--;
/* 523 */             chunkPrimerIn.setBlockState(i1, j1, l, iblockstate1);
/*     */             
/* 525 */             if (j == 0 && iblockstate1.getBlock() == Blocks.sand) {
/*     */               
/* 527 */               j = rand.nextInt(4) + Math.max(0, j1 - 63);
/* 528 */               iblockstate1 = (iblockstate1.getValue((IProperty)BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND) ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState();
/*     */             } 
/*     */           } 
/*     */         } 
/*     */       } 
...
/* 542 */     return createMutatedBiome(this.biomeID + 128);
/*     */   }
/*     */ 
/*     */   
/*     */   protected BiomeGenBase createMutatedBiome(int p_180277_1_) {
/* 547 */     return new BiomeGenMutated(p_180277_1_, this);
/*     */   }
/*     */ 
/*     */   
/*     */   public Class<? extends BiomeGenBase> getBiomeClass() {
/* 552 */     return (Class)getClass();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 560 */     return (biome == this) ? true : ((biome == null) ? false : ((getBiomeClass() == biome.getBiomeClass())));
/*     */   }
/*     */ 
/*     */   
/*     */   public TempCategory getTempCategory() {
/* 565 */     return (this.temperature < 0.2D) ? TempCategory.COLD : ((this.temperature < 1.0D) ? TempCategory.MEDIUM : TempCategory.WARM);
/*     */   }
/*     */ 
/*     */   
/*     */   public static BiomeGenBase[] getBiomeGenArray() {
/* 570 */     return biomeList;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 578 */     return getBiomeFromBiomeList(id, null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static BiomeGenBase getBiomeFromBiomeList(int biomeId, BiomeGenBase biome) {
/* 583 */     if (biomeId >= 0 && biomeId <= biomeList.length) {
/*     */       
/* 585 */       BiomeGenBase biomegenbase = biomeList[biomeId];
/* 586 */       return (biomegenbase == null) ? biome : biomegenbase;
/*     */     } 
/*     */ 
/*     */     
/* 590 */     logger.warn("Biome ID is out of bounds: " + biomeId + ", defaulting to 0 (Ocean)");
/* 591 */     return ocean;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   static {
/* 597 */     plains.createMutation();
/* 598 */     desert.createMutation();
/* 599 */     forest.createMutation();
/* 600 */     taiga.createMutation();
/* 601 */     swampland.createMutation();
/* 602 */     icePlains.createMutation();
/* 603 */     jungle.createMutation();
/* 604 */     jungleEdge.createMutation();
/* 605 */     coldTaiga.createMutation();
/* 606 */     savanna.createMutation();
/* 607 */     savannaPlateau.createMutation();
/* 608 */     mesa.createMutation();
/* 609 */     mesaPlateau_F.createMutation();
/* 610 */     mesaPlateau.createMutation();
/* 611 */     birchForest.createMutation();
/* 612 */     birchForestHills.createMutation();
/* 613 */     roofedForest.createMutation();
/* 614 */     megaTaiga.createMutation();
/* 615 */     extremeHills.createMutation();
/* 616 */     extremeHillsPlus.createMutation();
/* 617 */     megaTaiga.createMutatedBiome(megaTaigaHills.biomeID + 128).setBiomeName("Redwood Taiga Hills M");
/*     */     
/* 619 */     for (BiomeGenBase biomegenbase : biomeList) {
/*     */       
/* 621 */       if (biomegenbase != null) {
/*     */         
/* 623 */         if (BIOME_ID_MAP.containsKey(biomegenbase.biomeName))
/*     */         {
/* 625 */           throw new Error("Biome \"" + biomegenbase.biomeName + "\" is defined as both ID " + ((BiomeGenBase)BIOME_ID_MAP.get(biomegenbase.biomeName)).biomeID + " and " + biomegenbase.biomeID);
/*     */         }
/*     */         
/* 628 */         BIOME_ID_MAP.put(biomegenbase.biomeName, biomegenbase);
/*     */         
/* 630 */         if (biomegenbase.biomeID < 128)
/*     */         {
/* 632 */           explorationBiomesList.add(biomegenbase);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
/* 637 */     explorationBiomesList.remove(hell);
/* 638 */     explorationBiomesList.remove(sky);
/* 639 */     explorationBiomesList.remove(frozenOcean);
/* 640 */     explorationBiomesList.remove(extremeHillsEdge);
/* 641 */   } protected static final NoiseGeneratorPerlin temperatureNoise = new NoiseGeneratorPerlin(new Random(1234L), 1);
/* 642 */   protected static final NoiseGeneratorPerlin GRASS_COLOR_NOISE = new NoiseGeneratorPerlin(new Random(2345L), 1);
/* 643 */   protected static final WorldGenDoublePlant DOUBLE_PLANT_GENERATOR = new WorldGenDoublePlant(); public String biomeName; public int color; public int field_150609_ah; public float minHeight; public float maxHeight; public float temperature; public float rainfall; public int waterColorMultiplier; public BiomeDecorator theBiomeDecorator; protected List<SpawnListEntry> spawnableMonsterList; protected List<SpawnListEntry> spawnableCreatureList; protected List<SpawnListEntry> spawnableWaterCreatureList; protected List<SpawnListEntry> spawnableCaveCreatureList; protected boolean enableSnow;
...
/* 653 */       this.rootHeight = rootHeightIn;
/* 654 */       this.variation = variationIn;
/*     */     }
/*     */     public float variation;
/*     */     
/*     */     public Height attenuate() {
/* 659 */       return new Height(this.rootHeight * 0.8F, this.variation * 0.6F);
/*     */     } }
/*     */ 
/*     */   
...
/* 671 */       super(weight);
/* 672 */       this.entityClass = entityclassIn;
/* 673 */       this.minGroupCount = groupCountMin;
/* 674 */       this.maxGroupCount = groupCountMax;
/*     */     }
/*     */ 
/*     */     
/*     */     public String toString() {
/* 679 */       return this.entityClass.getSimpleName() + "*(" + this.minGroupCount + "-" + this.maxGroupCount + "):" + this.itemWeight;
/*     */     }
/*     */   }
/*     */   
