...
/* 81 */     return loadBlockGeneratorData(listToReuse, x, z, width, length);
/*    */   }
/*    */ 
/*    */   
/*    */   public BlockPos findBiomePosition(int x, int z, int range, List<BiomeGenBase> biomes, Random random) {
/* 86 */     return biomes.contains(this.biomeGenerator) ? new BlockPos(x - range + random.nextInt(range * 2 + 1), 0, z - range + random.nextInt(range * 2 + 1)) : null;
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 94 */     return p_76940_4_.contains(this.biomeGenerator);
/*    */   }
/*    */ }
