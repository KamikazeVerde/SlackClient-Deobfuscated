...
/*     */     int j;
/*  31 */     for (j = position.getY() + i - 2 - rand.nextInt(4); j > position.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
/*     */       
...
/*     */     {
/* 120 */       setBlockAndNotifyAdequately(p_181632_1_, p_181632_3_, Blocks.vine.getDefaultState().withProperty((IProperty)p_181632_4_, Boolean.TRUE));
/*     */     }
/*     */   }
/*     */ 
/*     */   
