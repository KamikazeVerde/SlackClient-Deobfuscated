...
/*  19 */   private static final IBlockState field_181649_b = Blocks.leaves.getDefaultState().withProperty((IProperty)BlockOldLeaf.VARIANT, (Comparable)BlockPlanks.EnumType.OAK).withProperty((IProperty)BlockOldLeaf.CHECK_DECAY, Boolean.FALSE);
/*     */ 
/*     */   
...
/* 190 */     IBlockState iblockstate = Blocks.vine.getDefaultState().withProperty((IProperty)p_181647_3_, Boolean.TRUE);
