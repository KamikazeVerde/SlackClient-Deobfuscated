...
/* 113 */             int j3 = 0;
/*     */             
/* 115 */             for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
/*     */               
/* 117 */               if (worldIn.getBlockState(blockpos2.offset(enumfacing)).getBlock().getMaterial().isSolid())
/*     */               {
/* 119 */                 j3++;
/*     */               }
/*     */             } 
...
/* 123 */             if (j3 == 1) {
/*     */               
/* 125 */               worldIn.setBlockState(blockpos2, Blocks.chest.correctFacing(worldIn, blockpos2, Blocks.chest.getDefaultState()), 2);
/* 126 */               List<WeightedRandomChestContent> list = WeightedRandomChestContent.func_177629_a(CHESTCONTENT, new WeightedRandomChestContent[] { Items.enchanted_book.getRandom(rand) });
/* 127 */               TileEntity tileentity1 = worldIn.getTileEntity(blockpos2);
/*     */               
/* 129 */               if (tileentity1 instanceof net.minecraft.tileentity.TileEntityChest)
/*     */               {
/* 131 */                 WeightedRandomChestContent.generateChestContents(rand, list, (IInventory)tileentity1, 8);
/*     */               }
/*     */               
/*     */               break;
/*     */             } 
...
/*     */         
/* 145 */         ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setEntityName(pickMobSpawner(rand));
/*     */       }
/*     */       else {
/*     */         
/* 149 */         field_175918_a.error("Failed to fetch mob spawner entity at (" + position.getX() + ", " + position.getY() + ", " + position.getZ() + ")");
/*     */       } 
/*     */       
/* 152 */       return true;
/*     */     } 
...
/* 165 */     return SPAWNERTYPES[p_76543_1_.nextInt(SPAWNERTYPES.length)];
/*     */   }
/*     */ }
