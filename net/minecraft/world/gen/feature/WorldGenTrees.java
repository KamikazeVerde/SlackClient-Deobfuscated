...
/*  22 */   private static final IBlockState field_181654_b = Blocks.leaves.getDefaultState().withProperty((IProperty)BlockOldLeaf.VARIANT, (Comparable)BlockPlanks.EnumType.OAK).withProperty((IProperty)BlockLeaves.CHECK_DECAY, Boolean.FALSE);
/*     */ 
/*     */   
...
/* 220 */                   func_181652_a(worldIn, rand.nextInt(3), position.add(enumfacing1.getFrontOffsetX(), i - 5 + l3, enumfacing1.getFrontOffsetZ()), enumfacing);
/*     */                 } 
/*     */               } 
/*     */             } 
/*     */           }
...
/* 243 */     setBlockAndNotifyAdequately(p_181652_1_, p_181652_3_, Blocks.cocoa.getDefaultState().withProperty((IProperty)BlockCocoa.AGE, Integer.valueOf(p_181652_2_)).withProperty((IProperty)BlockCocoa.FACING, (Comparable)p_181652_4_));
/*     */   }
/*     */ 
/*     */   
/*     */   private void func_181651_a(World p_181651_1_, BlockPos p_181651_2_, PropertyBool p_181651_3_) {
/* 248 */     setBlockAndNotifyAdequately(p_181651_1_, p_181651_2_, Blocks.vine.getDefaultState().withProperty((IProperty)p_181651_3_, Boolean.TRUE));
/*     */   }
/*     */ 
/*     */   
...
/* 254 */     int i = 4;
/*     */     
/* 256 */     for (p_181650_2_ = p_181650_2_.down(); p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air && i > 0; i--) {
/*     */       
/* 258 */       func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
/* 259 */       p_181650_2_ = p_181650_2_.down();
/*     */     } 
/*     */   }
/*     */ }
