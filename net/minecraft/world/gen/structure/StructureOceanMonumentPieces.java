...
/*  710 */       list1.add(new StructureOceanMonumentPieces.XYDoubleRoomFitHelper());
/*  711 */       list1.add(new StructureOceanMonumentPieces.YZDoubleRoomFitHelper());
/*  712 */       list1.add(new StructureOceanMonumentPieces.ZDoubleRoomFitHelper());
/*  713 */       list1.add(new StructureOceanMonumentPieces.XDoubleRoomFitHelper());
/*  714 */       list1.add(new StructureOceanMonumentPieces.YDoubleRoomFitHelper());
/*  715 */       list1.add(new StructureOceanMonumentPieces.FitSimpleRoomTopHelper());
/*  716 */       list1.add(new StructureOceanMonumentPieces.FitSimpleRoomHelper());
/*      */ 
/*      */       
...
/*      */             {
/*  809 */               for (EnumFacing enumfacing : EnumFacing.values()) {
/*      */                 
...
/*      */       
/*  858 */       for (StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition4 : astructureoceanmonumentpieces$roomdefinition) {
/*      */         
