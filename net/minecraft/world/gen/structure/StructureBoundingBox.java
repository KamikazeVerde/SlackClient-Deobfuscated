...
/* 173 */     return (vec.getX() >= this.minX && vec.getX() <= this.maxX && vec.getZ() >= this.minZ && vec.getZ() <= this.maxZ && vec.getY() >= this.minY && vec.getY() <= this.maxY);
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3i func_175896_b() {
/* 178 */     return new Vec3i(this.maxX - this.minX, this.maxY - this.minY, this.maxZ - this.minZ);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int getXSize() {
/* 186 */     return this.maxX - this.minX + 1;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int getYSize() {
/* 194 */     return this.maxY - this.minY + 1;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int getZSize() {
/* 202 */     return this.maxZ - this.minZ + 1;
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3i getCenter() {
/* 207 */     return (Vec3i)new BlockPos(this.minX + (this.maxX - this.minX + 1) / 2, this.minY + (this.maxY - this.minY + 1) / 2, this.minZ + (this.maxZ - this.minZ + 1) / 2);
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 212 */     return Objects.toStringHelper(this).add("x0", this.minX).add("y0", this.minY).add("z0", this.minZ).add("x1", this.maxX).add("y1", this.maxY).add("z1", this.maxZ).toString();
/*     */   }
/*     */ 
/*     */   
/*     */   public NBTTagIntArray toNBTTagIntArray() {
/* 217 */     return new NBTTagIntArray(new int[] { this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ });
/*     */   }
/*     */ }
