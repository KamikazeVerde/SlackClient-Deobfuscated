...
/*     */         
/* 257 */         if (!this.field_74940_h[enumfacing.getHorizontalIndex()]) {
/*     */           
/* 259 */           int l1 = enumfacing.getFrontOffsetX() * 2;
/* 260 */           int i2 = enumfacing.getFrontOffsetZ() * 2;
/* 261 */           this.field_74940_h[enumfacing.getHorizontalIndex()] = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + l1, -11, 10 + i2, WeightedRandomChestContent.func_177629_a(itemsToGenerateInTemple, new WeightedRandomChestContent[] { Items.enchanted_book.getRandom(randomIn) }), 2 + randomIn.nextInt(5));
/*     */         } 
/*     */       } 
/*     */       
/* 265 */       return true;
...
/*     */           
/* 332 */           blockpos$mutableblockpos.func_181079_c(l, 64, k);
/*     */           
...
/* 378 */       tagCompound.setBoolean("placedMainChest", this.field_74947_h);
/* 379 */       tagCompound.setBoolean("placedHiddenChest", this.field_74948_i);
/* 380 */       tagCompound.setBoolean("placedTrap1", this.field_74945_j);
/* 381 */       tagCompound.setBoolean("placedTrap2", this.field_74946_k);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void readStructureFromNBT(NBTTagCompound tagCompound) {
/* 386 */       super.readStructureFromNBT(tagCompound);
/* 387 */       this.field_74947_h = tagCompound.getBoolean("placedMainChest");
/* 388 */       this.field_74948_i = tagCompound.getBoolean("placedHiddenChest");
/* 389 */       this.field_74945_j = tagCompound.getBoolean("placedTrap1");
/* 390 */       this.field_74946_k = tagCompound.getBoolean("placedTrap2");
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
...
/* 508 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.EAST.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.TRUE), 1, -3, 8, structureBoundingBoxIn);
/* 509 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.WEST.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.TRUE), 4, -3, 8, structureBoundingBoxIn);
/* 510 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.TRUE), 2, -3, 8, structureBoundingBoxIn);
/* 511 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.TRUE), 3, -3, 8, structureBoundingBoxIn);
...
/*     */       
/* 522 */       if (!this.field_74945_j)
/*     */       {
/* 524 */         this.field_74945_j = generateDispenserContents(worldIn, structureBoundingBoxIn, randomIn, 3, -2, 1, EnumFacing.NORTH.getIndex(), field_175815_j, 2);
/*     */       }
/*     */       
/* 527 */       setBlockState(worldIn, Blocks.vine.getStateFromMeta(15), 3, -2, 2, structureBoundingBoxIn);
/* 528 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.NORTH.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.TRUE), 7, -3, 1, structureBoundingBoxIn);
/* 529 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.SOUTH.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.TRUE), 7, -3, 5, structureBoundingBoxIn);
/* 530 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.TRUE), 7, -3, 2, structureBoundingBoxIn);
/* 531 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.TRUE), 7, -3, 3, structureBoundingBoxIn);
/* 532 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.TRUE), 7, -3, 4, structureBoundingBoxIn);
...
/*     */       
/* 539 */       if (!this.field_74946_k)
/*     */       {
/* 541 */         this.field_74946_k = generateDispenserContents(worldIn, structureBoundingBoxIn, randomIn, 9, -2, 3, EnumFacing.WEST.getIndex(), field_175815_j, 2);
/*     */       }
/*     */       
...
/*     */       
/* 547 */       if (!this.field_74947_h)
/*     */       {
/* 549 */         this.field_74947_h = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 8, -3, 3, WeightedRandomChestContent.func_177629_a(field_175816_i, new WeightedRandomChestContent[] { Items.enchanted_book.getRandom(randomIn) }), 2 + randomIn.nextInt(5));
/*     */       }
/*     */       
...
/*     */       
/* 580 */       if (!this.field_74948_i)
/*     */       {
/* 582 */         this.field_74948_i = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 9, -3, 10, WeightedRandomChestContent.func_177629_a(field_175816_i, new WeightedRandomChestContent[] { Items.enchanted_book.getRandom(randomIn) }), 2 + randomIn.nextInt(5));
/*     */       }
/*     */       
/* 585 */       return true;
/*     */     }
...
/* 691 */           entitywitch.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(l1, i2, k1)), null);
