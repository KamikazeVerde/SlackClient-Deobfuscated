...
/* 609 */       int k = 0;
/*     */       
/* 611 */       for (int lvt_5_1_ = 0; k < this.boundingBox.getXSize(); k += 4) {
/*     */         
/* 613 */         k += rand.nextInt(this.boundingBox.getXSize());
/*     */         
/* 615 */         if (k + 3 > this.boundingBox.getXSize()) {
/*     */           break;
/*     */         }
/*     */ 
/*     */         
/* 620 */         StructureComponent structurecomponent = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
/*     */         
/* 622 */         if (structurecomponent != null) {
/*     */           
/* 624 */           StructureBoundingBox structureboundingbox = structurecomponent.getBoundingBox();
/* 625 */           this.roomsLinkedToTheRoom.add(new StructureBoundingBox(structureboundingbox.minX, structureboundingbox.minY, this.boundingBox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, this.boundingBox.minZ + 1));
/*     */         } 
/*     */       } 
/*     */       
/* 629 */       for (k = 0; k < this.boundingBox.getXSize(); k += 4) {
/*     */         
/* 631 */         k += rand.nextInt(this.boundingBox.getXSize());
/*     */         
/* 633 */         if (k + 3 > this.boundingBox.getXSize()) {
/*     */           break;
/*     */         }
/*     */ 
/*     */         
/* 638 */         StructureComponent structurecomponent1 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
/*     */         
/* 640 */         if (structurecomponent1 != null) {
/*     */           
/* 642 */           StructureBoundingBox structureboundingbox1 = structurecomponent1.getBoundingBox();
/* 643 */           this.roomsLinkedToTheRoom.add(new StructureBoundingBox(structureboundingbox1.minX, structureboundingbox1.minY, this.boundingBox.maxZ - 1, structureboundingbox1.maxX, structureboundingbox1.maxY, this.boundingBox.maxZ));
/*     */         } 
/*     */       } 
/*     */       
/* 647 */       for (k = 0; k < this.boundingBox.getZSize(); k += 4) {
/*     */         
/* 649 */         k += rand.nextInt(this.boundingBox.getZSize());
/*     */         
/* 651 */         if (k + 3 > this.boundingBox.getZSize()) {
/*     */           break;
/*     */         }
/*     */ 
/*     */         
/* 656 */         StructureComponent structurecomponent2 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
/*     */         
/* 658 */         if (structurecomponent2 != null) {
/*     */           
/* 660 */           StructureBoundingBox structureboundingbox2 = structurecomponent2.getBoundingBox();
/* 661 */           this.roomsLinkedToTheRoom.add(new StructureBoundingBox(this.boundingBox.minX, structureboundingbox2.minY, structureboundingbox2.minZ, this.boundingBox.minX + 1, structureboundingbox2.maxY, structureboundingbox2.maxZ));
/*     */         } 
/*     */       } 
/*     */       
/* 665 */       for (k = 0; k < this.boundingBox.getZSize(); k += 4) {
/*     */         
/* 667 */         k += rand.nextInt(this.boundingBox.getZSize());
/*     */         
/* 669 */         if (k + 3 > this.boundingBox.getZSize()) {
/*     */           break;
/*     */         }
/*     */ 
/*     */         
/* 674 */         StructureComponent structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
/*     */         
/* 676 */         if (structurecomponent3 != null) {
/*     */           
/* 678 */           StructureBoundingBox structureboundingbox3 = structurecomponent3.getBoundingBox();
/* 679 */           this.roomsLinkedToTheRoom.add(new StructureBoundingBox(this.boundingBox.maxX - 1, structureboundingbox3.minY, structureboundingbox3.minZ, this.boundingBox.maxX, structureboundingbox3.maxY, structureboundingbox3.maxZ));
/*     */         } 
/*     */       } 
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
/* 686 */       if (isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn))
/*     */       {
/* 688 */         return false;
/*     */       }
/*     */ 
/*     */       
/* 692 */       fillWithBlocks(worldIn, structureBoundingBoxIn, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY, this.boundingBox.maxZ, Blocks.dirt.getDefaultState(), Blocks.air.getDefaultState(), true);
/* 693 */       fillWithBlocks(worldIn, structureBoundingBoxIn, this.boundingBox.minX, this.boundingBox.minY + 1, this.boundingBox.minZ, this.boundingBox.maxX, Math.min(this.boundingBox.minY + 3, this.boundingBox.maxY), this.boundingBox.maxZ, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
/*     */       
/* 695 */       for (StructureBoundingBox structureboundingbox : this.roomsLinkedToTheRoom)
/*     */       {
/* 697 */         fillWithBlocks(worldIn, structureBoundingBoxIn, structureboundingbox.minX, structureboundingbox.maxY - 2, structureboundingbox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, structureboundingbox.maxZ, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
/*     */       }
/*     */       
/* 700 */       randomlyRareFillWithBlocks(worldIn, structureBoundingBoxIn, this.boundingBox.minX, this.boundingBox.minY + 4, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ, Blocks.air.getDefaultState(), false);
/* 701 */       return true;
/*     */     }
/*     */ 
/*     */ 
...
/* 707 */       super.func_181138_a(p_181138_1_, p_181138_2_, p_181138_3_);
/*     */       
/* 709 */       for (StructureBoundingBox structureboundingbox : this.roomsLinkedToTheRoom)
/*     */       {
/* 711 */         structureboundingbox.offset(p_181138_1_, p_181138_2_, p_181138_3_);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     protected void writeStructureToNBT(NBTTagCompound tagCompound) {
/* 717 */       NBTTagList nbttaglist = new NBTTagList();
/*     */       
/* 719 */       for (StructureBoundingBox structureboundingbox : this.roomsLinkedToTheRoom)
/*     */       {
/* 721 */         nbttaglist.appendTag((NBTBase)structureboundingbox.toNBTTagIntArray());
/*     */       }
/*     */       
/* 724 */       tagCompound.setTag("Entrances", (NBTBase)nbttaglist);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void readStructureFromNBT(NBTTagCompound tagCompound) {
/* 729 */       NBTTagList nbttaglist = tagCompound.getTagList("Entrances", 11);
/*     */       
/* 731 */       for (int i = 0; i < nbttaglist.tagCount(); i++)
/*     */       {
/* 733 */         this.roomsLinkedToTheRoom.add(new StructureBoundingBox(nbttaglist.getIntArrayAt(i)));
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 746 */       super(type);
/* 747 */       this.coordBaseMode = facing;
/* 748 */       this.boundingBox = structurebb;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 761 */       StructureBoundingBox structureboundingbox = new StructureBoundingBox(x, y - 5, z, x, y + 2, z);
/*     */       
/* 763 */       switch (facing) {
/*     */         
/*     */         case NORTH:
/* 766 */           structureboundingbox.maxX = x + 2;
/* 767 */           structureboundingbox.minZ = z - 8;
/*     */           break;
/*     */         
/*     */         case SOUTH:
/* 771 */           structureboundingbox.maxX = x + 2;
/* 772 */           structureboundingbox.maxZ = z + 8;
/*     */           break;
/*     */         
/*     */         case WEST:
/* 776 */           structureboundingbox.minX = x - 8;
/* 777 */           structureboundingbox.maxZ = z + 2;
/*     */           break;
/*     */         
/*     */         case EAST:
/* 781 */           structureboundingbox.maxX = x + 8;
/* 782 */           structureboundingbox.maxZ = z + 2;
/*     */           break;
/*     */       } 
/* 785 */       return (StructureComponent.findIntersecting(listIn, structureboundingbox) != null) ? null : structureboundingbox;
/*     */     }
/*     */ 
/*     */     
/*     */     public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
/* 790 */       int i = getComponentType();
/*     */       
/* 792 */       if (this.coordBaseMode != null)
/*     */       {
/* 794 */         switch (this.coordBaseMode) {
/*     */           
/*     */           case NORTH:
/* 797 */             StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
/*     */             break;
/*     */           
/*     */           case SOUTH:
/* 801 */             StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
/*     */             break;
/*     */           
/*     */           case WEST:
/* 805 */             StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i);
/*     */             break;
/*     */           
/*     */           case EAST:
/* 809 */             StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i);
/*     */             break;
/*     */         } 
/*     */       }
/*     */     }
...
/*     */ 
/*     */       
/* 822 */       fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 2, 7, 1, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
/* 823 */       fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, 7, 2, 2, 8, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
/*     */       
/* 825 */       for (int i = 0; i < 5; i++)
/*     */       {
/* 827 */         fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5 - i - ((i < 4) ? 1 : 0), 2 + i, 2, 7 - i, 2 + i, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
/*     */       }
/*     */       
/* 830 */       return true;
/*     */     }
