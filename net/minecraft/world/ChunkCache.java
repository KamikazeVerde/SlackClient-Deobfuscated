...
/* 120 */         int l = 0;
/*     */         
/* 122 */         for (EnumFacing enumfacing : EnumFacing.values()) {
/*     */           
...
/* 160 */     return (getBlockState(pos).getBlock().getMaterial() == Material.air);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getLightFor(EnumSkyBlock p_175628_1_, BlockPos pos) {
/* 165 */     if (pos.getY() >= 0 && pos.getY() < 256) {
/*     */       
/* 167 */       int i = (pos.getX() >> 4) - this.chunkX;
/* 168 */       int j = (pos.getZ() >> 4) - this.chunkZ;
/* 169 */       return this.chunkArray[i][j].getLightFor(p_175628_1_, pos);
/*     */     } 
/*     */ 
/*     */     
/* 173 */     return p_175628_1_.defaultLightValue;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public int getStrongPower(BlockPos pos, EnumFacing direction) {
/* 179 */     IBlockState iblockstate = getBlockState(pos);
/* 180 */     return iblockstate.getBlock().isProvidingStrongPower(this, pos, iblockstate, direction);
/*     */   }
/*     */ 
/*     */   
/*     */   public WorldType getWorldType() {
/* 185 */     return this.worldObj.getWorldType();
/*     */   }
/*     */ }
