...
/*   98 */   private ServerBlockEventList[] field_147490_S = new ServerBlockEventList[] { new ServerBlockEventList(), new ServerBlockEventList() };
...
/*      */       
/*  179 */       if (getGameRules().getGameRuleBooleanValue("doDaylightCycle")) {
/*      */         
...
/*      */     
/*  190 */     if (getGameRules().getGameRuleBooleanValue("doMobSpawning") && this.worldInfo.getTerrainType() != WorldType.DEBUG_WORLD)
/*      */     {
...
/*      */     
/*  206 */     if (getGameRules().getGameRuleBooleanValue("doDaylightCycle"))
/*      */     {
...
/*  406 */         if (l2 > 0)
/*      */         {
/*  408 */           for (ExtendedBlockStorage extendedblockstorage : chunk.getBlockStorageArray()) {
/*      */             
...
/* 1153 */     S2APacketParticles s2APacketParticles = new S2APacketParticles(particleType, longDistance, (float)xCoord, (float)yCoord, (float)zCoord, (float)xOffset, (float)yOffset, (float)zOffset, (float)particleSpeed, numberOfParticles, p_180505_18_);
/*      */     
/* 1155 */     for (int i = 0; i < this.playerEntities.size(); i++) {
/*      */       
/* 1157 */       EntityPlayerMP entityplayermp = (EntityPlayerMP)this.playerEntities.get(i);
/* 1158 */       BlockPos blockpos = entityplayermp.getPosition();
/* 1159 */       double d0 = blockpos.distanceSq(xCoord, yCoord, zCoord);
/*      */       
/* 1161 */       if (d0 <= 256.0D || (longDistance && d0 <= 65536.0D))
/*      */       {
/* 1163 */         entityplayermp.playerNetServerHandler.sendPacket((Packet)s2APacketParticles);
/*      */       }
/*      */     } 
/*      */   }
/*      */ 
...
/* 1170 */     return this.entitiesByUuid.get(uuid);
/*      */   }
/*      */ 
/*      */   
/*      */   public ListenableFuture<Object> addScheduledTask(Runnable runnableToSchedule) {
/* 1175 */     return this.mcServer.addScheduledTask(runnableToSchedule);
/*      */   }
/*      */ 
/*      */   
/*      */   public boolean isCallingFromMinecraftThread() {
/* 1180 */     return this.mcServer.isCallingFromMinecraftThread();
/*      */   }
/*      */   
