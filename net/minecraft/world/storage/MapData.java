...
/*  31 */   public Map<String, Vec4b> playersVisibleOnMap = Maps.newLinkedHashMap();
/*     */ 
/*     */   
...
/*     */     {
/* 119 */       this.playersVisibleOnMap.remove(player.getCommandSenderName());
/*     */     }
/*     */     
...
/*     */         {
/* 130 */           updatePlayersVisibleOnMap(0, mapdata$mapinfo1.entityplayerObj.worldObj, mapdata$mapinfo1.entityplayerObj.getCommandSenderName(), mapdata$mapinfo1.entityplayerObj.posX, mapdata$mapinfo1.entityplayerObj.posZ, mapdata$mapinfo1.entityplayerObj.rotationYaw);
/*     */         }
/*     */       }
/*     */       else {
/*     */         
...
/* 144 */       updatePlayersVisibleOnMap(1, player.worldObj, "frame-" + entityitemframe.getEntityId(), blockpos.getX(), blockpos.getZ(), (entityitemframe.facingDirection.getHorizontalIndex() * 90));
/*     */     } 
/*     */     
...
/*     */         
/* 155 */         if (!this.playersVisibleOnMap.containsKey(nbttagcompound.getString("id")))
/*     */         {
/* 157 */           updatePlayersVisibleOnMap(nbttagcompound.getByte("type"), player.worldObj, nbttagcompound.getString("id"), nbttagcompound.getDouble("x"), nbttagcompound.getDouble("z"), nbttagcompound.getDouble("rot"));
/*     */         }
/*     */       } 
/*     */     } 
/*     */   }
...
/*     */         
/* 188 */         this.playersVisibleOnMap.remove(entityIdentifier);
/*     */         
/*     */         return;
/*     */       } 
/* 192 */       type = 6;
...
/*     */     } 
/*     */     
/* 216 */     this.playersVisibleOnMap.put(entityIdentifier, new Vec4b((byte)type, b0, b1, b2));
/*     */   }
/*     */ 
/*     */   
...
/* 270 */         return (Packet)new S34PacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.playersVisibleOnMap.values(), MapData.this.colors, this.minX, this.minY, this.maxX + 1 - this.minX, this.maxY + 1 - this.minY);
/*     */       } 
/*     */ 
/*     */       
/* 274 */       return (this.field_176109_i++ % 5 == 0) ? (Packet)new S34PacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.playersVisibleOnMap.values(), MapData.this.colors, 0, 0, 0, 0) : null;
/*     */     }
/*     */ 
/*     */ 
/*     */     
