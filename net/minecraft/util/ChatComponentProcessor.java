...
/*    */         }
/*    */         
/* 30 */         s = ((Entity)list.get(0)).getCommandSenderName();
/*    */       } 
/*    */       
/* 33 */       ichatcomponent = (entityIn != null && s.equals("*")) ? new ChatComponentScore(entityIn.getCommandSenderName(), chatcomponentscore.getObjective()) : new ChatComponentScore(s, chatcomponentscore.getObjective());
