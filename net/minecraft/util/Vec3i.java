...
/*  99 */     double d0 = getX() - toX;
/* 100 */     double d1 = getY() - toY;
/* 101 */     double d2 = getZ() - toZ;
...
/* 110 */     double d0 = getX() + 0.5D - xIn;
/* 111 */     double d1 = getY() + 0.5D - yIn;
/* 112 */     double d2 = getZ() + 0.5D - zIn;
...
/* 121 */     return distanceSq(to.getX(), to.getY(), to.getZ());
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 126 */     return Objects.toStringHelper(this).add("x", getX()).add("y", getY()).add("z", getZ()).toString();
/*     */   }
/*     */ }
