...
/*  62 */     for (FishType itemfishfood$fishtype : FishType.values()) {
/*     */       
/*  64 */       if (!this.cooked || itemfishfood$fishtype.canCook())
/*     */       {
/*  66 */         subItems.add(new ItemStack(this, 1, itemfishfood$fishtype.getMetadata()));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*  77 */     FishType itemfishfood$fishtype = FishType.byItemStack(stack);
/*  78 */     return getUnlocalizedName() + "." + itemfishfood$fishtype.getUnlocalizedName() + "." + ((this.cooked && itemfishfood$fishtype.canCook()) ? "cooked" : "raw");
/*     */   }
/*     */   
/*     */   public enum FishType
/*     */   {
/*  83 */     COD(0, "cod", 2, 0.1F, 5, 0.6F),
/*  84 */     SALMON(1, "salmon", 2, 0.1F, 6, 0.8F),
/*  85 */     CLOWNFISH(2, "clownfish", 1, 0.1F),
/*  86 */     PUFFERFISH(3, "pufferfish", 1, 0.1F);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     static {
/* 166 */       for (FishType itemfishfood$fishtype : values())
/*     */       {
/* 168 */         META_LOOKUP.put(Integer.valueOf(itemfishfood$fishtype.getMetadata()), itemfishfood$fishtype);
/*     */       }
/*     */     }
/*     */     
