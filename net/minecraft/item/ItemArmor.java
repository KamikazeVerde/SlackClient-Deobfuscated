...
/* 218 */     return (this.material.getRepairItem() == repair.getItem()) ? true : super.getIsRepairable(toRepair, repair);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 226 */     int i = EntityLiving.getArmorPosition(itemStackIn) - 1;
/* 227 */     ItemStack itemstack = playerIn.getCurrentArmor(i);
/*     */     
/* 229 */     if (itemstack == null) {
/*     */       
/* 231 */       playerIn.setCurrentItemOrArmor(i, itemStackIn.copy());
/* 232 */       itemStackIn.stackSize = 0;
/*     */     } 
/*     */     
/* 235 */     return itemStackIn;
/*     */   }
/*     */   
/*     */   public enum ArmorMaterial
/*     */   {
/* 240 */     LEATHER("leather", 5, (String)new int[] { 1, 3, 2, 1 }, 15),
/* 241 */     CHAIN("chainmail", 15, (String)new int[] { 2, 5, 4, 1 }, 12),
/* 242 */     IRON("iron", 15, (String)new int[] { 2, 6, 5, 2 }, 9),
/* 243 */     GOLD("gold", 7, (String)new int[] { 2, 5, 3, 1 }, 25),
/* 244 */     DIAMOND("diamond", 33, (String)new int[] { 3, 8, 6, 3 }, 10);
/*     */     
...
/* 253 */       this.name = name;
/* 254 */       this.maxDamageFactor = maxDamage;
/* 255 */       this.damageReductionAmountArray = reductionAmounts;
/* 256 */       this.enchantability = enchantability;
/*     */     }
/*     */ 
/*     */     
/*     */     public int getDurability(int armorType) {
/* 261 */       return ItemArmor.maxDamageArray[armorType] * this.maxDamageFactor;
/*     */     }
/*     */ 
/*     */     
/*     */     public int getDamageReductionAmount(int armorType) {
/* 266 */       return this.damageReductionAmountArray[armorType];
/*     */     }
/*     */ 
/*     */     
/*     */     public int getEnchantability() {
/* 271 */       return this.enchantability;
/*     */     }
/*     */ 
/*     */     
/*     */     public Item getRepairItem() {
/* 276 */       return (this == LEATHER) ? Items.leather : ((this == CHAIN) ? Items.iron_ingot : ((this == GOLD) ? Items.gold_ingot : ((this == IRON) ? Items.iron_ingot : ((this == DIAMOND) ? Items.diamond : null))));
/*     */     }
/*     */ 
/*     */     
