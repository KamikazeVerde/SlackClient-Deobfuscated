...
/*     */     
/*  52 */     for (ItemFishFood.FishType itemfishfood$fishtype : ItemFishFood.FishType.values()) {
/*     */       
...
/*  75 */     addSmelting(Item.getItemFromBlock(input), stack, experience);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  87 */     addSmeltingRecipe(new ItemStack(input, 1, 32767), stack, experience);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     this.smeltingList.put(input, stack);
/* 100 */     this.experienceList.put(stack, Float.valueOf(experience));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 108 */     for (Map.Entry<ItemStack, ItemStack> entry : this.smeltingList.entrySet()) {
/*     */       
/* 110 */       if (compareItemStacks(stack, entry.getKey()))
/*     */       {
...
/* 124 */     return (stack2.getItem() == stack1.getItem() && (stack2.getMetadata() == 32767 || stack2.getMetadata() == stack1.getMetadata()));
/*     */   }
/*     */ 
/*     */   
/*     */   public Map<ItemStack, ItemStack> getSmeltingList() {
/* 129 */     return this.smeltingList;
/*     */   }
/*     */ 
/*     */   
/*     */   public float getSmeltingExperience(ItemStack stack) {
/* 134 */     for (Map.Entry<ItemStack, Float> entry : this.experienceList.entrySet()) {
/*     */       
/* 136 */       if (compareItemStacks(stack, entry.getKey()))
/*     */       {
/* 138 */         return ((Float)entry.getValue()).floatValue();
/*     */       }
/*     */     } 
/*     */     
/* 142 */     return 0.0F;
