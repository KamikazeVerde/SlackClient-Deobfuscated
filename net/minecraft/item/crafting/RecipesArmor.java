...
/* 19 */     for (int i = 0; i < (this.recipeItems[0]).length; i++) {
/*    */       
/* 21 */       Item item = this.recipeItems[0][i];
/*    */       
/* 23 */       for (int j = 0; j < this.recipeItems.length - 1; j++) {
/*    */         
/* 25 */         Item item1 = this.recipeItems[j + 1][i];
/* 26 */         craftManager.addRecipe(new ItemStack(item1), new Object[] { this.recipePatterns[j], Character.valueOf('X'), item });
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
