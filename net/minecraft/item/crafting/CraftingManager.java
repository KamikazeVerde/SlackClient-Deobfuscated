...
/* 280 */     List<ItemStack> list = Lists.newArrayList();
/*     */     
/* 282 */     for (Object object : recipeComponents) {
/*     */       
/* 284 */       if (object instanceof ItemStack) {
/*     */         
/* 286 */         list.add(((ItemStack)object).copy());
/*     */       }
/* 288 */       else if (object instanceof Item) {
/*     */         
/* 290 */         list.add(new ItemStack((Item)object));
/*     */       }
/*     */       else {
/*     */         
/* 294 */         if (!(object instanceof Block))
/*     */         {
/* 296 */           throw new IllegalArgumentException("Invalid shapeless recipe: unknown type " + object.getClass().getName() + "!");
/*     */         }
/*     */         
/* 299 */         list.add(new ItemStack((Block)object));
/*     */       } 
/*     */     } 
/*     */     
/* 303 */     this.recipes.add(new ShapelessRecipes(stack, list));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 321 */     for (IRecipe irecipe : this.recipes) {
/*     */       
/* 323 */       if (irecipe.matches(p_82787_1_, worldIn))
/*     */       {
/* 325 */         return irecipe.getCraftingResult(p_82787_1_);
/*     */       }
/*     */     } 
/*     */     
/* 329 */     return null;
...
/* 334 */     for (IRecipe irecipe : this.recipes) {
/*     */       
/* 336 */       if (irecipe.matches(p_180303_1_, worldIn))
/*     */       {
/* 338 */         return irecipe.getRemainingItems(p_180303_1_);
/*     */       }
/*     */     } 
/*     */     
/* 342 */     ItemStack[] aitemstack = new ItemStack[p_180303_1_.getSizeInventory()];
/*     */     
/* 344 */     for (int i = 0; i < aitemstack.length; i++)
/*     */     {
/* 346 */       aitemstack[i] = p_180303_1_.getStackInSlot(i);
/*     */     }
/*     */     
/* 349 */     return aitemstack;
/*     */   }
/*     */ 
/*     */   
/*     */   public List<IRecipe> getRecipeList() {
/* 354 */     return this.recipes;
/*     */   }
/*     */ }
