...
/*     */     
/* 101 */     if (BlockRailBase.isRailBlock(iblockstate)) {
/*     */       
/* 103 */       if (!worldIn.isRemote) {
/*     */         
/* 105 */         BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = (iblockstate.getBlock() instanceof BlockRailBase) ? (BlockRailBase.EnumRailDirection)iblockstate.getValue(((BlockRailBase)iblockstate.getBlock()).getShapeProperty()) : BlockRailBase.EnumRailDirection.NORTH_SOUTH;
/* 106 */         double d0 = 0.0D;
/*     */         
/* 108 */         if (blockrailbase$enumraildirection.isAscending())
/*     */         {
/* 110 */           d0 = 0.5D;
/*     */         }
/*     */         
/* 113 */         EntityMinecart entityminecart = EntityMinecart.func_180458_a(worldIn, pos.getX() + 0.5D, pos.getY() + 0.0625D + d0, pos.getZ() + 0.5D, this.minecartType);
/*     */         
/* 115 */         if (stack.hasDisplayName())
/*     */         {
/* 117 */           entityminecart.setCustomNameTag(stack.getDisplayName());
/*     */         }
/*     */         
/* 120 */         worldIn.spawnEntityInWorld((Entity)entityminecart);
/*     */       } 
/*     */       
/* 123 */       stack.stackSize--;
/* 124 */       return true;
