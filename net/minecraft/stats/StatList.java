...
/* 249 */     func_151180_a(p_75924_0_, (Block)Blocks.water, (Block)Blocks.flowing_water);
/* 250 */     func_151180_a(p_75924_0_, (Block)Blocks.lava, (Block)Blocks.flowing_lava);
/* 251 */     func_151180_a(p_75924_0_, Blocks.lit_pumpkin, Blocks.pumpkin);
/* 252 */     func_151180_a(p_75924_0_, Blocks.lit_furnace, Blocks.furnace);
/* 253 */     func_151180_a(p_75924_0_, Blocks.lit_redstone_ore, Blocks.redstone_ore);
/* 254 */     func_151180_a(p_75924_0_, (Block)Blocks.powered_repeater, (Block)Blocks.unpowered_repeater);
/* 255 */     func_151180_a(p_75924_0_, (Block)Blocks.powered_comparator, (Block)Blocks.unpowered_comparator);
/* 256 */     func_151180_a(p_75924_0_, Blocks.redstone_torch, Blocks.unlit_redstone_torch);
/* 257 */     func_151180_a(p_75924_0_, Blocks.lit_redstone_lamp, Blocks.redstone_lamp);
/* 258 */     func_151180_a(p_75924_0_, (Block)Blocks.double_stone_slab, (Block)Blocks.stone_slab);
/* 259 */     func_151180_a(p_75924_0_, (Block)Blocks.double_wooden_slab, (Block)Blocks.wooden_slab);
/* 260 */     func_151180_a(p_75924_0_, (Block)Blocks.double_stone_slab2, (Block)Blocks.stone_slab2);
/* 261 */     func_151180_a(p_75924_0_, (Block)Blocks.grass, Blocks.dirt);
/* 262 */     func_151180_a(p_75924_0_, Blocks.farmland, Blocks.dirt);
/*     */   }
/*     */ 
/*     */   
/*     */   private static void func_151180_a(StatBase[] statBaseIn, Block p_151180_1_, Block p_151180_2_) {
/* 267 */     int i = Block.getIdFromBlock(p_151180_1_);
/* 268 */     int j = Block.getIdFromBlock(p_151180_2_);
/*     */     
/* 270 */     if (statBaseIn[i] != null && statBaseIn[j] == null) {
/*     */       
/* 272 */       statBaseIn[j] = statBaseIn[i];
/*     */     }
/*     */     else {
/*     */       
/* 276 */       allStats.remove(statBaseIn[i]);
/* 277 */       objectMineStats.remove(statBaseIn[i]);
/* 278 */       generalStats.remove(statBaseIn[i]);
/* 279 */       statBaseIn[i] = statBaseIn[j];
/*     */     } 
/*     */   }
/*     */ 
/*     */   
/*     */   public static StatBase getStatKillEntity(EntityList.EntityEggInfo eggInfo) {
/* 285 */     String s = EntityList.getStringFromID(eggInfo.spawnedID);
/* 286 */     return (s == null) ? null : (new StatBase("stat.killEntity." + s, (IChatComponent)new ChatComponentTranslation("stat.entityKill", new Object[] { new ChatComponentTranslation("entity." + s + ".name", new Object[0]) }))).registerStat();
/*     */   }
/*     */ 
/*     */   
/*     */   public static StatBase getStatEntityKilledBy(EntityList.EntityEggInfo eggInfo) {
/* 291 */     String s = EntityList.getStringFromID(eggInfo.spawnedID);
/* 292 */     return (s == null) ? null : (new StatBase("stat.entityKilledBy." + s, (IChatComponent)new ChatComponentTranslation("stat.entityKilledBy", new Object[] { new ChatComponentTranslation("entity." + s + ".name", new Object[0]) }))).registerStat();
/*     */   }
/*     */ 
/*     */   
/*     */   public static StatBase getOneShotStat(String p_151177_0_) {
/* 297 */     return oneShotStats.get(p_151177_0_);
/*     */   }
/*     */ }
