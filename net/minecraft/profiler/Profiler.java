...
/* 151 */     long j = this.profilingMap.containsKey(p_76321_1_) ? ((Long)this.profilingMap.get(p_76321_1_)).longValue() : -1L;
/* 152 */     List<Result> list = Lists.newArrayList();
/*     */     
/* 154 */     if (p_76321_1_.length() > 0)
/*     */     {
/* 156 */       p_76321_1_ = p_76321_1_ + ".";
/*     */     }
/*     */     
/* 159 */     long k = 0L;
/*     */     
...
/*     */       
/* 163 */       if (s.length() > p_76321_1_.length() && s.startsWith(p_76321_1_) && s.indexOf(".", p_76321_1_.length() + 1) < 0)
/*     */       {
...
/*     */       
/* 183 */       if (s1.length() > p_76321_1_.length() && s1.startsWith(p_76321_1_) && s1.indexOf(".", p_76321_1_.length() + 1) < 0) {
/*     */         
/* 185 */         long l = ((Long)this.profilingMap.get(s1)).longValue();
/* 186 */         double d0 = l * 100.0D / k;
/* 187 */         double d1 = l * 100.0D / i;
/* 188 */         String s2 = s1.substring(p_76321_1_.length());
...
/* 204 */     list.add(0, new Result(p_76321_1_, 100.0D, k * 100.0D / i));
/* 205 */     return list;
/*     */   }
/*     */ 
/*     */ 
...
/* 242 */       this.field_76331_c = p_i1554_1_;
/* 243 */       this.field_76332_a = p_i1554_2_;
/* 244 */       this.field_76330_b = p_i1554_4_;
/*     */     }
/*     */ 
/*     */     
