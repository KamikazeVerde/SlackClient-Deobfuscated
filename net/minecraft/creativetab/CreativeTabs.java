...
/*     */ 
/*     */     
/* 232 */     for (EnumEnchantmentType enumenchantmenttype : this.enchantmentTypes) {
/*     */       
...
/* 270 */     for (Enchantment enchantment : Enchantment.enchantmentsBookList) {
/*     */       
/* 272 */       if (enchantment != null && enchantment.type != null) {
/*     */         
/* 274 */         boolean flag = false;
/*     */         
/* 276 */         for (int i = 0; i < enchantmentType.length && !flag; i++) {
/*     */           
/* 278 */           if (enchantment.type == enchantmentType[i])
/*     */           {
/* 280 */             flag = true;
/*     */           }
/*     */         } 
...
/* 284 */         if (flag)
/*     */         {
/* 286 */           itemList.add(Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(enchantment, enchantment.getMaxLevel())));
/*     */         }
/*     */       } 
/*     */     } 
/*     */   }
