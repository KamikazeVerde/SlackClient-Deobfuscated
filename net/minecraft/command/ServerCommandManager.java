...
/* 122 */     MinecraftServer minecraftserver = MinecraftServer.getServer();
/*     */     
/* 124 */     if (!sender.sendCommandFeedback())
/*     */     {
/* 126 */       flag = false;
/*     */     }
/*     */     
/* 129 */     ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("chat.type.admin", new Object[] { sender.getCommandSenderName(), new ChatComponentTranslation(msgFormat, msgParams) });
/* 130 */     chatComponentTranslation.getChatStyle().setColor(ChatFormatting.GRAY);
/* 131 */     chatComponentTranslation.getChatStyle().setItalic(Boolean.TRUE);
/*     */     
/* 133 */     if (flag)
/*     */     {
/* 135 */       for (EntityPlayer entityplayer : minecraftserver.getConfigurationManager().func_181057_v()) {
/*     */         
/* 137 */         if (entityplayer != sender && minecraftserver.getConfigurationManager().canSendCommands(entityplayer.getGameProfile()) && command.canCommandSenderUseCommand(sender)) {
/*     */           
/* 139 */           boolean flag1 = (sender instanceof MinecraftServer && MinecraftServer.getServer().func_183002_r());
/* 140 */           boolean flag2 = (sender instanceof net.minecraft.network.rcon.RConConsoleSource && MinecraftServer.getServer().func_181034_q());
/*     */           
/* 142 */           if (flag1 || flag2 || (!(sender instanceof net.minecraft.network.rcon.RConConsoleSource) && !(sender instanceof MinecraftServer)))
/*     */           {
/* 144 */             entityplayer.addChatMessage((IChatComponent)chatComponentTranslation);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     }
/*     */     
/* 150 */     if (sender != minecraftserver && minecraftserver.worldServers[0].getGameRules().getGameRuleBooleanValue("logAdminCommands"))
/*     */     {
/* 152 */       minecraftserver.addChatMessage((IChatComponent)chatComponentTranslation);
/*     */     }
/*     */     
/* 155 */     boolean flag3 = minecraftserver.worldServers[0].getGameRules().getGameRuleBooleanValue("sendCommandFeedback");
/*     */     
/* 157 */     if (sender instanceof CommandBlockLogic)
/*     */     {
/* 159 */       flag3 = ((CommandBlockLogic)sender).shouldTrackOutput();
/*     */     }
/*     */     
/* 162 */     if (((flags & 0x1) != 1 && flag3) || sender instanceof MinecraftServer)
/*     */     {
/* 164 */       sender.addChatMessage((IChatComponent)new ChatComponentTranslation(msgFormat, msgParams));
/*     */     }
/*     */   }
/*     */ }
