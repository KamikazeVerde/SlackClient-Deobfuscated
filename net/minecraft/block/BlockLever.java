...
/*  27 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, EnumOrientation.NORTH).withProperty((IProperty)POWERED, Boolean.FALSE));
...
/*  81 */     IBlockState iblockstate = getDefaultState().withProperty((IProperty)POWERED, Boolean.FALSE);
/*     */     
...
/*     */       {
/* 376 */         META_LOOKUP[blocklever$enumorientation.getMetadata()] = blocklever$enumorientation;
/*     */       }
/*     */     }
/*     */     
