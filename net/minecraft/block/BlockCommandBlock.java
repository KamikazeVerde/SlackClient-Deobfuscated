...
/*  27 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)TRIGGERED, Boolean.FALSE));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  48 */       if (flag && !flag1) {
/*     */         
/*  50 */         worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.TRUE), 4);
/*  51 */         worldIn.scheduleUpdate(pos, this, tickRate(worldIn));
/*     */       }
/*  53 */       else if (!flag && flag1) {
/*     */         
/*  55 */         worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.FALSE), 4);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/*     */       {
/* 114 */         commandblocklogic.setTrackOutput(worldIn.getGameRules().getGameRuleBooleanValue("sendCommandFeedback"));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 169 */     return getDefaultState().withProperty((IProperty)TRIGGERED, Boolean.FALSE);
/*     */   }
/*     */ }
