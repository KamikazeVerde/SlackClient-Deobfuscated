...
/*  31 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)WET, Boolean.FALSE));
...
/*  40 */     return StatCollector.translateToLocal(getUnlocalizedName() + ".dry.name");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  70 */       worldIn.setBlockState(pos, state.withProperty((IProperty)WET, Boolean.TRUE), 2);
