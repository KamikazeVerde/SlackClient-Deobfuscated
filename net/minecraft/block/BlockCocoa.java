...
/* 159 */     int i = ((Integer)state.getValue((IProperty)AGE)).intValue();
/* 160 */     int j = 1;
/*     */     
/* 162 */     if (i >= 2)
/*     */     {
...
/*     */     {
/* 169 */       spawnAsEntity(worldIn, pos, new ItemStack(Items.dye, 1, EnumDyeColor.BROWN.getDyeDamage()));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 178 */     return Items.dye;
/*     */   }
/*     */ 
/*     */   
/*     */   public int getDamageValue(World worldIn, BlockPos pos) {
/* 183 */     return EnumDyeColor.BROWN.getDyeDamage();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 191 */     return (((Integer)state.getValue((IProperty)AGE)).intValue() < 2);
/*     */   }
/*     */ 
/*     */   
...
/* 201 */     worldIn.setBlockState(pos, state.withProperty((IProperty)AGE, Integer.valueOf(((Integer)state.getValue((IProperty)AGE)).intValue() + 1)), 2);
/*     */   }
/*     */ 
/*     */   
/*     */   public EnumWorldBlockLayer getBlockLayer() {
/* 206 */     return EnumWorldBlockLayer.CUTOUT;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 214 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.getHorizontal(meta)).withProperty((IProperty)AGE, Integer.valueOf((meta & 0xF) >> 2));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 222 */     int i = 0;
/* 223 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getHorizontalIndex();
/* 224 */     i |= ((Integer)state.getValue((IProperty)AGE)).intValue() << 2;
/* 225 */     return i;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 230 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)AGE });
/*     */   }
/*     */ }
