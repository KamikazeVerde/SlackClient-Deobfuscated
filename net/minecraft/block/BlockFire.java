...
/*  68 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)AGE, Integer.valueOf(0)).withProperty((IProperty)FLIP, Boolean.FALSE).withProperty((IProperty)ALT, Boolean.FALSE).withProperty((IProperty)NORTH, Boolean.FALSE).withProperty((IProperty)EAST, Boolean.FALSE).withProperty((IProperty)SOUTH, Boolean.FALSE).withProperty((IProperty)WEST, Boolean.FALSE).withProperty((IProperty)UPPER, Integer.valueOf(0)));
...
/*     */       {
/* 313 */         Blocks.tnt.onBlockDestroyedByPlayer(worldIn, pos, iblockstate.withProperty((IProperty)BlockTNT.EXPLODE, Boolean.TRUE));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 320 */     for (EnumFacing enumfacing : EnumFacing.values()) {
/*     */       
...
/* 339 */     int i = 0;
/*     */     
/* 341 */     for (EnumFacing enumfacing : EnumFacing.values())
/*     */     {
