...
/*  36 */     super(true);
/*  37 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)POWERED, Boolean.FALSE).withProperty((IProperty)SHAPE, BlockRailBase.EnumRailDirection.NORTH_SOUTH));
...
/* 107 */     if (flag1 && !flag) {
/*     */       
/* 109 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.TRUE), 3);
...
/* 115 */     if (!flag1 && flag) {
/*     */       
/* 117 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.FALSE), 3);
