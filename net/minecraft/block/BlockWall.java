...
/*  34 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)UP, Boolean.FALSE).withProperty((IProperty)NORTH, Boolean.FALSE).withProperty((IProperty)EAST, Boolean.FALSE).withProperty((IProperty)SOUTH, Boolean.FALSE).withProperty((IProperty)WEST, Boolean.FALSE).withProperty((IProperty)VARIANT, EnumType.NORMAL));
...
/* 133 */     for (EnumType blockwall$enumtype : EnumType.values())
/*     */     {
...
/*     */     
/*     */     static {
/* 231 */       for (EnumType blockwall$enumtype : values())
/*     */       {
