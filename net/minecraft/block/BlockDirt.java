...
/*  28 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)VARIANT, DirtType.DIRT).withProperty((IProperty)SNOWY, Boolean.FALSE));
...
/*     */     
/*     */     static {
/* 169 */       for (DirtType blockdirt$dirttype : values())
/*     */       {
