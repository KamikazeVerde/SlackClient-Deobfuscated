...
/*  90 */     Predicate[][][] arrayOfPredicate = (Predicate[][][])Array.newInstance(Predicate.class, new int[] { this.depth.size(), this.aisleHeight, this.rowWidth });
/*     */     
...
/*     */         {
/*  98 */           arrayOfPredicate[i][j][k] = this.symbolMap.get(Character.valueOf(((String[])this.depth.get(i))[j].charAt(k)));
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
/* 103 */     return (Predicate<BlockWorldState>[][][])arrayOfPredicate;
/*     */   }
/*     */ 
/*     */   
