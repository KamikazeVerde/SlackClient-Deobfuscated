...
/*  56 */       StateImplementation blockstate$stateimplementation = new StateImplementation(blockIn, ImmutableMap.copyOf(map1));
...
/*     */       
/* 181 */       for (UnmodifiableIterator<IProperty<? extends Comparable>> unmodifiableIterator = this.properties.keySet().iterator(); unmodifiableIterator.hasNext(); ) { IProperty<? extends Comparable> iproperty = unmodifiableIterator.next();
/*     */         
/* 183 */         for (Comparable comparable : iproperty.getAllowedValues()) {
/*     */           
/* 185 */           if (comparable != this.properties.get(iproperty))
/*     */           {
/* 187 */             hashBasedTable.put(iproperty, comparable, map.get(setPropertyValue(iproperty, comparable)));
/*     */           }
/*     */         }  }
/*     */ 
/*     */       
