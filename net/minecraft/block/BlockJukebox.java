...
/*  28 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)HAS_RECORD, Boolean.FALSE));
...
/*  37 */       state = state.withProperty((IProperty)HAS_RECORD, Boolean.FALSE);
...
/*  56 */         worldIn.setBlockState(pos, state.withProperty((IProperty)HAS_RECORD, Boolean.TRUE), 2);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     
/* 127 */     if (tileentity instanceof TileEntityJukebox) {
/*     */       
/* 129 */       ItemStack itemstack = ((TileEntityJukebox)tileentity).getRecord();
/*     */       
/* 131 */       if (itemstack != null)
/*     */       {
/* 133 */         return Item.getIdFromItem(itemstack.getItem()) + 1 - Item.getIdFromItem(Items.record_13);
/*     */       }
/*     */     } 
/*     */     
/* 137 */     return 0;
...
/*     */       
/* 177 */       if (compound.hasKey("RecordItem", 10)) {
/*     */         
/* 179 */         setRecord(ItemStack.loadItemStackFromNBT(compound.getCompoundTag("RecordItem")));
/*     */       }
/* 181 */       else if (compound.getInteger("Record") > 0) {
/*     */         
/* 183 */         setRecord(new ItemStack(Item.getItemById(compound.getInteger("Record")), 1, 0));
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/*     */       
/* 191 */       if (getRecord() != null)
/*     */       {
/* 193 */         compound.setTag("RecordItem", (NBTBase)getRecord().writeToNBT(new NBTTagCompound()));
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public ItemStack getRecord() {
/* 199 */       return this.record;
/*     */     }
/*     */ 
/*     */     
/*     */     public void setRecord(ItemStack recordStack) {
/* 204 */       this.record = recordStack;
/* 205 */       markDirty();
/*     */     }
/*     */   }
/*     */ }
