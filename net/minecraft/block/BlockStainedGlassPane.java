...
/* 25 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)NORTH, Boolean.FALSE).withProperty((IProperty)EAST, Boolean.FALSE).withProperty((IProperty)SOUTH, Boolean.FALSE).withProperty((IProperty)WEST, Boolean.FALSE).withProperty((IProperty)COLOR, (Comparable)EnumDyeColor.WHITE));
