...
/*  31 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)POWERED, Boolean.FALSE));
...
/*  96 */     return func_181088_a(worldIn, pos, facing.getOpposite()) ? getDefaultState().withProperty((IProperty)FACING, (Comparable)facing).withProperty((IProperty)POWERED, Boolean.FALSE) : getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.DOWN).withProperty((IProperty)POWERED, Boolean.FALSE);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 175 */     worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.TRUE), 3);
...
/*     */         else {
/*     */           
/* 231 */           worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.FALSE));
...
/* 275 */     if (flag && !flag1) {
/*     */       
/* 277 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.TRUE));
...
/* 283 */     if (!flag && flag1) {
/*     */       
/* 285 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.FALSE));
