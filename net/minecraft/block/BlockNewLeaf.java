...
/*     */   
/*     */   public BlockNewLeaf() {
/*  31 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)VARIANT, BlockPlanks.EnumType.ACACIA).withProperty((IProperty)CHECK_DECAY, Boolean.TRUE).withProperty((IProperty)DECAYABLE, Boolean.TRUE));
/*     */   }
/*     */ 
/*     */   
