...
/*     */             {
/*  73 */               worldIn.setBlockState(blockpos, iblockstate.withProperty((IProperty)CHECK_DECAY, Boolean.TRUE), 4);
/*     */             }
/*     */           } 
/*     */         } 
/*     */       } 
...
/* 180 */         if (l2 >= 0) {
/*     */           
/* 182 */           worldIn.setBlockState(pos, state.withProperty((IProperty)CHECK_DECAY, Boolean.FALSE), 4);
/*     */         }
/*     */         else {
/*     */           
...
/* 224 */     return Item.getItemFromBlock(Blocks.sapling);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 237 */       int i = getSaplingDropChance(state);
/*     */       
/* 239 */       if (fortune > 0) {
/*     */         
/* 241 */         i -= 2 << fortune;
...
/*     */       } 
/*     */       
/* 249 */       if (worldIn.rand.nextInt(i) == 0) {
/*     */         
/* 251 */         Item item = getItemDropped(state, worldIn.rand, fortune);
/* 252 */         spawnAsEntity(worldIn, pos, new ItemStack(item, 1, damageDropped(state)));
/*     */       } 
/*     */       
/* 255 */       i = 200;
/*     */       
...
/*     */       } 
/*     */       
/* 267 */       dropApple(worldIn, pos, state, i);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 293 */     this.isTransparent = fancy;
/* 294 */     this.fancyGraphics = fancy;
/* 295 */     this.iconIndex = fancy ? 0 : 1;
/*     */   }
/*     */ 
/*     */   
/*     */   public EnumWorldBlockLayer getBlockLayer() {
/* 300 */     return this.isTransparent ? EnumWorldBlockLayer.CUTOUT_MIPPED : EnumWorldBlockLayer.SOLID;
/*     */   }
/*     */ 
/*     */   
