...
/* 537 */     setBaseCollisionBounds((IBlockAccess)worldIn, pos);
/* 538 */     super.addCollisionBoxesToList(worldIn, pos, state, mask, list, collidingEntity);
/* 539 */     boolean flag = func_176306_h((IBlockAccess)worldIn, pos);
/* 540 */     super.addCollisionBoxesToList(worldIn, pos, state, mask, list, collidingEntity);
/*     */     
/* 542 */     if (flag && func_176304_i((IBlockAccess)worldIn, pos))
/*     */     {
/* 544 */       super.addCollisionBoxesToList(worldIn, pos, state, mask, list, collidingEntity);
/*     */     }
/*     */     
/* 547 */     setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
/* 552 */     this.modelBlock.randomDisplayTick(worldIn, pos, state, rand);
/*     */   }
/*     */ 
/*     */   
/*     */   public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
/* 557 */     this.modelBlock.onBlockClicked(worldIn, pos, playerIn);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 565 */     this.modelBlock.onBlockDestroyedByPlayer(worldIn, pos, state);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
/* 570 */     return this.modelBlock.getMixedBrightnessForBlock(worldIn, pos);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 578 */     return this.modelBlock.getExplosionResistance(exploder);
/*     */   }
/*     */ 
/*     */   
/*     */   public EnumWorldBlockLayer getBlockLayer() {
/* 583 */     return this.modelBlock.getBlockLayer();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 591 */     return this.modelBlock.tickRate(worldIn);
/*     */   }
/*     */ 
/*     */   
/*     */   public AxisAlignedBB getSelectedBoundingBox(World worldIn, BlockPos pos) {
/* 596 */     return this.modelBlock.getSelectedBoundingBox(worldIn, pos);
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3 modifyAcceleration(World worldIn, BlockPos pos, Entity entityIn, Vec3 motion) {
/* 601 */     return this.modelBlock.modifyAcceleration(worldIn, pos, entityIn, motion);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 609 */     return this.modelBlock.isCollidable();
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canCollideCheck(IBlockState state, boolean hitIfLiquid) {
/* 614 */     return this.modelBlock.canCollideCheck(state, hitIfLiquid);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
/* 619 */     return this.modelBlock.canPlaceBlockAt(worldIn, pos);
/*     */   }
/*     */ 
/*     */   
/*     */   public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
/* 624 */     onNeighborBlockChange(worldIn, pos, this.modelState, Blocks.air);
/* 625 */     this.modelBlock.onBlockAdded(worldIn, pos, this.modelState);
/*     */   }
/*     */ 
/*     */   
/*     */   public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
/* 630 */     this.modelBlock.breakBlock(worldIn, pos, this.modelState);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 638 */     this.modelBlock.onEntityCollidedWithBlock(worldIn, pos, entityIn);
/*     */   }
/*     */ 
/*     */   
/*     */   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
/* 643 */     this.modelBlock.updateTick(worldIn, pos, state, rand);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
/* 648 */     return this.modelBlock.onBlockActivated(worldIn, pos, this.modelState, playerIn, EnumFacing.DOWN, 0.0F, 0.0F, 0.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 656 */     this.modelBlock.onBlockDestroyedByExplosion(worldIn, pos, explosionIn);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 664 */     return this.modelBlock.getMapColor(this.modelState);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 673 */     IBlockState iblockstate = super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer);
/* 674 */     iblockstate = iblockstate.withProperty((IProperty)FACING, (Comparable)placer.getHorizontalFacing()).withProperty((IProperty)SHAPE, EnumShape.STRAIGHT);
/* 675 */     return (facing != EnumFacing.DOWN && (facing == EnumFacing.UP || hitY <= 0.5D)) ? iblockstate.withProperty((IProperty)HALF, EnumHalf.BOTTOM) : iblockstate.withProperty((IProperty)HALF, EnumHalf.TOP);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 686 */     MovingObjectPosition[] amovingobjectposition = new MovingObjectPosition[8];
/* 687 */     IBlockState iblockstate = worldIn.getBlockState(pos);
/* 688 */     int i = ((EnumFacing)iblockstate.getValue((IProperty)FACING)).getHorizontalIndex();
/* 689 */     boolean flag = (iblockstate.getValue((IProperty)HALF) == EnumHalf.TOP);
/* 690 */     int[] aint = field_150150_a[i + (flag ? 4 : 0)];
/* 691 */     this.hasRaytraced = true;
/*     */     
/* 693 */     for (int j = 0; j < 8; j++) {
/*     */       
/* 695 */       this.rayTracePass = j;
/*     */       
/* 697 */       if (Arrays.binarySearch(aint, j) < 0)
/*     */       {
/* 699 */         amovingobjectposition[j] = super.collisionRayTrace(worldIn, pos, start, end);
/*     */       }
/*     */     } 
/*     */     
/* 703 */     for (int k : aint)
/*     */     {
/* 705 */       amovingobjectposition[k] = null;
/*     */     }
/*     */     
/* 708 */     MovingObjectPosition movingobjectposition1 = null;
/* 709 */     double d1 = 0.0D;
/*     */     
/* 711 */     for (MovingObjectPosition movingobjectposition : amovingobjectposition) {
/*     */       
/* 713 */       if (movingobjectposition != null) {
/*     */         
/* 715 */         double d0 = movingobjectposition.hitVec.squareDistanceTo(end);
/*     */         
/* 717 */         if (d0 > d1) {
/*     */           
/* 719 */           movingobjectposition1 = movingobjectposition;
/* 720 */           d1 = d0;
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
/* 725 */     return movingobjectposition1;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 733 */     IBlockState iblockstate = getDefaultState().withProperty((IProperty)HALF, ((meta & 0x4) > 0) ? EnumHalf.TOP : EnumHalf.BOTTOM);
/* 734 */     iblockstate = iblockstate.withProperty((IProperty)FACING, (Comparable)EnumFacing.getFront(5 - (meta & 0x3)));
/* 735 */     return iblockstate;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 743 */     int i = 0;
/*     */     
/* 745 */     if (state.getValue((IProperty)HALF) == EnumHalf.TOP)
/*     */     {
/* 747 */       i |= 0x4;
/*     */     }
/*     */     
/* 750 */     i |= 5 - ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/* 751 */     return i;
/*     */   }
/*     */ 
/*     */ 
...
/* 760 */     if (func_176306_h(worldIn, pos)) {
/*     */       
/* 762 */       switch (func_176305_g(worldIn, pos)) {
/*     */         
/*     */         case 0:
/* 765 */           state = state.withProperty((IProperty)SHAPE, EnumShape.STRAIGHT);
/*     */           break;
/*     */         
/*     */         case 1:
/* 769 */           state = state.withProperty((IProperty)SHAPE, EnumShape.INNER_RIGHT);
/*     */           break;
/*     */         
/*     */         case 2:
/* 773 */           state = state.withProperty((IProperty)SHAPE, EnumShape.INNER_LEFT);
/*     */           break;
/*     */       } 
/*     */     
/*     */     } else {
/* 778 */       switch (func_176307_f(worldIn, pos)) {
/*     */         
/*     */         case 0:
/* 781 */           state = state.withProperty((IProperty)SHAPE, EnumShape.STRAIGHT);
/*     */           break;
/*     */         
/*     */         case 1:
/* 785 */           state = state.withProperty((IProperty)SHAPE, EnumShape.OUTER_RIGHT);
/*     */           break;
/*     */         
/*     */         case 2:
/* 789 */           state = state.withProperty((IProperty)SHAPE, EnumShape.OUTER_LEFT);
/*     */           break;
/*     */       } 
/*     */     } 
/* 793 */     return state;
...
/* 798 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)HALF, (IProperty)SHAPE });
/*     */   }
/*     */   
...
/*     */     implements IStringSerializable {
/* 826 */     STRAIGHT("straight"),
/* 827 */     INNER_LEFT("inner_left"),
/* 828 */     INNER_RIGHT("inner_right"),
/* 829 */     OUTER_LEFT("outer_left"),
/* 830 */     OUTER_RIGHT("outer_right");
/*     */     
/*     */     private final String name;
/*     */ 
/*     */     
