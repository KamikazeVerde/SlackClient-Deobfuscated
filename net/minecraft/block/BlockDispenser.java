...
/*  41 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)TRIGGERED, Boolean.FALSE));
...
/*     */       } 
/*     */       
/*  90 */       worldIn.setBlockState(pos, state.withProperty((IProperty)FACING, (Comparable)enumfacing).withProperty((IProperty)TRIGGERED, Boolean.FALSE), 2);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 165 */       worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.TRUE), 4);
/*     */     }
/* 167 */     else if (!flag && flag1) {
/*     */       
/* 169 */       worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.FALSE), 4);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 195 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)BlockPistonBase.getFacingFromEntity(worldIn, pos, placer)).withProperty((IProperty)TRIGGERED, Boolean.FALSE);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
