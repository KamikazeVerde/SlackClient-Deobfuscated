...
/*  28 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)EXPLODE, Boolean.FALSE));
...
/*     */       
/*  38 */       onBlockDestroyedByPlayer(worldIn, pos, state.withProperty((IProperty)EXPLODE, Boolean.TRUE));
...
/*     */       
/*  50 */       onBlockDestroyedByPlayer(worldIn, pos, state.withProperty((IProperty)EXPLODE, Boolean.TRUE));
...
/*     */         
/*  97 */         explode(worldIn, pos, state.withProperty((IProperty)EXPLODE, Boolean.TRUE), (EntityLivingBase)playerIn);
...
/*     */         
/* 127 */         explode(worldIn, pos, worldIn.getBlockState(pos).withProperty((IProperty)EXPLODE, Boolean.TRUE), (entityarrow.shootingEntity instanceof EntityLivingBase) ? (EntityLivingBase)entityarrow.shootingEntity : null);
