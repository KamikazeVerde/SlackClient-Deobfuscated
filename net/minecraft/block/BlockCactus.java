...
/*     */       
/* 108 */       if (worldIn.getBlockState(pos.offset(enumfacing)).getBlock().getMaterial().isSolid())
/*     */       {
/* 110 */         return false;
/*     */       }
/*     */     } 
/*     */     
/* 114 */     Block block = worldIn.getBlockState(pos.down()).getBlock();
/* 115 */     return (block == Blocks.cactus || block == Blocks.sand);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 136 */     return getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 144 */     return ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 149 */     return new BlockState(this, new IProperty[] { (IProperty)AGE });
/*     */   }
/*     */ }
