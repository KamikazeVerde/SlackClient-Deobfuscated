...
/*  78 */     return (this.damageType == 0) ? (level * 1.25F) : ((this.damageType == 1 && creatureType == EnumCreatureAttribute.UNDEAD) ? (level * 2.5F) : ((this.damageType == 2 && creatureType == EnumCreatureAttribute.ARTHROPOD) ? (level * 2.5F) : 0.0F));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  86 */     return "enchantment.damage." + protectionName[this.damageType];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  96 */     return !(ench instanceof EnchantmentDamage);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */     return (stack.getItem() instanceof net.minecraft.item.ItemAxe) ? true : super.canApply(stack);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */     if (target instanceof EntityLivingBase) {
/*     */       
/* 120 */       EntityLivingBase entitylivingbase = (EntityLivingBase)target;
/*     */       
/* 122 */       if (this.damageType == 2 && entitylivingbase.getCreatureAttribute() == EnumCreatureAttribute.ARTHROPOD) {
/*     */         
/* 124 */         int i = 20 + user.getRNG().nextInt(10 * level);
/* 125 */         entitylivingbase.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, i, 3));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
