...
/* 1481 */         consumer.accept(new AbstractObject2ObjectMap.BasicEntry<>(Object2ObjectLinkedOpenHashMap.this.key[curr], Object2ObjectLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1488 */       AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry<>();
/* 1489 */       for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1490 */         int curr = next;
/* 1491 */         next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1492 */         entry.key = Object2ObjectLinkedOpenHashMap.this.key[curr];
/* 1493 */         entry.value = Object2ObjectLinkedOpenHashMap.this.value[curr];
/* 1494 */         consumer.accept(entry);
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/* 1501 */     if (this.entries == null) this.entries = new MapEntrySet(); 
/* 1502 */     return this.entries;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K previous() {
/* 1520 */       return Object2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1532 */       action.accept(Object2ObjectLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1537 */       return Object2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1546 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1551 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1561 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1567 */       for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1568 */         int curr = next;
/* 1569 */         next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1570 */         consumer.accept(Object2ObjectLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1576 */       return Object2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1581 */       return Object2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1586 */       int oldSize = Object2ObjectLinkedOpenHashMap.this.size;
/* 1587 */       Object2ObjectLinkedOpenHashMap.this.remove(k);
/* 1588 */       return (Object2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1593 */       Object2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1598 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1599 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1604 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1605 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1631 */     if (this.keys == null) this.keys = new KeySet(); 
/* 1632 */     return this.keys;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*      */     public V previous() {
/* 1646 */       return Object2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1658 */       action.accept(Object2ObjectLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1663 */       return Object2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1669 */     if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 80;
/*      */           
/*      */           public ObjectIterator<V> iterator() {
/* 1674 */             return new Object2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1690 */             for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1691 */               int curr = next;
/* 1692 */               next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1693 */               consumer.accept(Object2ObjectLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1699 */             return Object2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1704 */             return Object2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1709 */             Object2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
/* 1712 */     return this.values;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1751 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1752 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f)) return true; 
/*      */     try {
/* 1754 */       rehash(l);
/* 1755 */     } catch (OutOfMemoryError cantDoIt) {
/* 1756 */       return false;
/*      */     } 
/* 1758 */     return true;
/*      */   }
...
/* 1773 */     K[] key = this.key;
/* 1774 */     V[] value = this.value;
/* 1775 */     int mask = newN - 1;
/* 1776 */     K[] newKey = (K[])new Object[newN + 1];
/* 1777 */     V[] newValue = (V[])new Object[newN + 1];
/* 1778 */     int i = this.first, prev = -1, newPrev = -1;
/* 1779 */     long[] link = this.link;
/* 1780 */     long[] newLink = new long[newN + 1];
/* 1781 */     this.first = -1;
/* 1782 */     for (int j = this.size; j-- != 0; ) {
/* 1783 */       int pos; if (key[i] == null) { pos = newN; }
/*      */       else
/* 1785 */       { pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1786 */         for (; newKey[pos] != null; pos = pos + 1 & mask); }
/*      */       
/* 1788 */       newKey[pos] = key[i];
/* 1789 */       newValue[pos] = value[i];
/* 1790 */       if (prev != -1) {
/* 1791 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1792 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1793 */         newPrev = pos;
/*      */       } else {
/* 1795 */         newPrev = this.first = pos;
/*      */         
/* 1797 */         newLink[pos] = -1L;
/*      */       } 
/* 1799 */       int t = i;
...
/* 1801 */       prev = t;
/*      */     } 
/* 1803 */     this.link = newLink;
/* 1804 */     this.last = newPrev;
/* 1805 */     if (newPrev != -1)
/*      */     {
/* 1807 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1808 */     this.n = newN;
/* 1809 */     this.mask = mask;
/* 1810 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1811 */     this.key = newKey;
/* 1812 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1829 */       c = (Object2ObjectLinkedOpenHashMap<K, V>)super.clone();
/* 1830 */     } catch (CloneNotSupportedException cantHappen) {
/* 1831 */       throw new InternalError();
/*      */     } 
/* 1833 */     c.keys = null;
/* 1834 */     c.values = null;
/* 1835 */     c.entries = null;
/* 1836 */     c.containsNullKey = this.containsNullKey;
/* 1837 */     c.key = (K[])this.key.clone();
/* 1838 */     c.value = (V[])this.value.clone();
/* 1839 */     c.link = (long[])this.link.clone();
/* 1840 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1854 */     int h = 0;
/* 1855 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1856 */       for (; this.key[i] == null; i++);
/* 1857 */       if (this != this.key[i]) t = this.key[i].hashCode(); 
/* 1858 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1859 */       h += t;
/* 1860 */       i++;
/*      */     } 
/*      */     
/* 1863 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1864 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1868 */     K[] key = this.key;
/* 1869 */     V[] value = this.value;
/* 1870 */     EntryIterator i = new EntryIterator();
/* 1871 */     s.defaultWriteObject();
/* 1872 */     for (int j = this.size; j-- != 0; ) {
/* 1873 */       int e = i.nextEntry();
/* 1874 */       s.writeObject(key[e]);
/* 1875 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/* 1882 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1883 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1884 */     this.mask = this.n - 1;
/* 1885 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1886 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1887 */     long[] link = this.link = new long[this.n + 1];
/* 1888 */     int prev = -1;
/* 1889 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1892 */     for (int i = this.size; i-- != 0; ) {
/* 1893 */       int pos; K k = (K)s.readObject();
/* 1894 */       V v = (V)s.readObject();
/* 1895 */       if (k == null) {
/* 1896 */         pos = this.n;
/* 1897 */         this.containsNullKey = true;
/*      */       } else {
/* 1899 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1900 */         for (; key[pos] != null; pos = pos + 1 & this.mask);
/*      */       } 
/* 1902 */       key[pos] = k;
/* 1903 */       value[pos] = v;
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\objects\Object2ObjectLinkedOpenHashMap.class
