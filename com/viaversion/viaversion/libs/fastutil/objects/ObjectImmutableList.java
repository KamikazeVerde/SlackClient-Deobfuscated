...
/* 234 */     if (a == null) {
/* 235 */       a = (K[])new Object[size()];
/* 236 */     } else if (a.length < size()) {
/* 237 */       a = (K[])Array.newInstance(a.getClass().getComponentType(), size());
/*     */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\objects\ObjectImmutableList.class
