...
/*  990 */       if (Object2ObjectOpenHashMap.this.containsNullKey) consumer.accept(new AbstractObject2ObjectMap.BasicEntry<>(Object2ObjectOpenHashMap.this.key[Object2ObjectOpenHashMap.this.n], Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n])); 
/*  991 */       for (int pos = Object2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenHashMap.this.key[pos] != null) consumer.accept(new AbstractObject2ObjectMap.BasicEntry<>(Object2ObjectOpenHashMap.this.key[pos], Object2ObjectOpenHashMap.this.value[pos]));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
/*  997 */       AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry<>();
/*  998 */       if (Object2ObjectOpenHashMap.this.containsNullKey) {
/*  999 */         entry.key = Object2ObjectOpenHashMap.this.key[Object2ObjectOpenHashMap.this.n];
/* 1000 */         entry.value = Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n];
/* 1001 */         consumer.accept(entry);
/*      */       } 
/* 1003 */       for (int pos = Object2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenHashMap.this.key[pos] != null) {
/* 1004 */           entry.key = Object2ObjectOpenHashMap.this.key[pos];
/* 1005 */           entry.value = Object2ObjectOpenHashMap.this.value[pos];
/* 1006 */           consumer.accept(entry);
/*      */         }  }
/*      */     
/*      */     }
/*      */   }
...
/* 1013 */     if (this.entries == null) this.entries = new MapEntrySet(); 
/* 1014 */     return this.entries;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1035 */       action.accept(Object2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1040 */       return Object2ObjectOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1051 */       super(pos, max, mustReturnNull, hasSplit);
/*      */     }
/*      */ 
/*      */     
/*      */     public int characteristics() {
/* 1056 */       return this.hasSplit ? 1 : 65;
/*      */     }
/*      */ 
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1061 */       action.accept(Object2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     final KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
/* 1066 */       return new KeySpliterator(pos, max, mustReturnNull, true);
/*      */     } }
/*      */   
...
/* 1073 */       return new Object2ObjectOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1078 */       return new Object2ObjectOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1084 */       if (Object2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Object2ObjectOpenHashMap.this.key[Object2ObjectOpenHashMap.this.n]); 
/* 1085 */       for (int pos = Object2ObjectOpenHashMap.this.n; pos-- != 0; ) {
/* 1086 */         K k = Object2ObjectOpenHashMap.this.key[pos];
/* 1087 */         if (k != null) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1093 */       return Object2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1098 */       return Object2ObjectOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1103 */       int oldSize = Object2ObjectOpenHashMap.this.size;
/* 1104 */       Object2ObjectOpenHashMap.this.remove(k);
/* 1105 */       return (Object2ObjectOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1110 */       Object2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectSet<K> keySet() {
/* 1116 */     if (this.keys == null) this.keys = new KeySet(); 
/* 1117 */     return this.keys;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1138 */       action.accept(Object2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1143 */       return Object2ObjectOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1154 */       super(pos, max, mustReturnNull, hasSplit);
/*      */     }
/*      */ 
/*      */     
/*      */     public int characteristics() {
/* 1159 */       return this.hasSplit ? 0 : 64;
/*      */     }
/*      */ 
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1164 */       action.accept(Object2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     final ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
/* 1169 */       return new ValueSpliterator(pos, max, mustReturnNull, true);
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1175 */     if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */         {
/*      */           public ObjectIterator<V> iterator() {
/* 1178 */             return new Object2ObjectOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1183 */             return new Object2ObjectOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1189 */             if (Object2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n]); 
/* 1190 */             for (int pos = Object2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenHashMap.this.key[pos] != null) consumer.accept(Object2ObjectOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Object2ObjectOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1200 */             return Object2ObjectOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1205 */             Object2ObjectOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1247 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1248 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f)) return true; 
/*      */     try {
/* 1250 */       rehash(l);
/* 1251 */     } catch (OutOfMemoryError cantDoIt) {
/* 1252 */       return false;
/*      */     } 
/* 1254 */     return true;
/*      */   }
...
/* 1269 */     K[] key = this.key;
/* 1270 */     V[] value = this.value;
/* 1271 */     int mask = newN - 1;
/* 1272 */     K[] newKey = (K[])new Object[newN + 1];
/* 1273 */     V[] newValue = (V[])new Object[newN + 1];
/* 1274 */     int i = this.n;
/* 1275 */     for (int j = realSize(); j-- != 0; ) {
/* 1276 */       while (key[--i] == null); int pos;
/* 1277 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null) while (newKey[pos = pos + 1 & mask] != null); 
/* 1278 */       newKey[pos] = key[i];
/* 1279 */       newValue[pos] = value[i];
/*      */     } 
/* 1281 */     newValue[newN] = value[this.n];
/* 1282 */     this.n = newN;
/* 1283 */     this.mask = mask;
/* 1284 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1285 */     this.key = newKey;
/* 1286 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1303 */       c = (Object2ObjectOpenHashMap<K, V>)super.clone();
/* 1304 */     } catch (CloneNotSupportedException cantHappen) {
/* 1305 */       throw new InternalError();
/*      */     } 
/* 1307 */     c.keys = null;
/* 1308 */     c.values = null;
/* 1309 */     c.entries = null;
/* 1310 */     c.containsNullKey = this.containsNullKey;
/* 1311 */     c.key = (K[])this.key.clone();
/* 1312 */     c.value = (V[])this.value.clone();
/* 1313 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1327 */     int h = 0;
/* 1328 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1329 */       for (; this.key[i] == null; i++);
/* 1330 */       if (this != this.key[i]) t = this.key[i].hashCode(); 
/* 1331 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1332 */       h += t;
/* 1333 */       i++;
/*      */     } 
/*      */     
/* 1336 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1337 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1341 */     K[] key = this.key;
/* 1342 */     V[] value = this.value;
/* 1343 */     EntryIterator i = new EntryIterator();
/* 1344 */     s.defaultWriteObject();
/* 1345 */     for (int j = this.size; j-- != 0; ) {
/* 1346 */       int e = i.nextEntry();
/* 1347 */       s.writeObject(key[e]);
/* 1348 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/* 1355 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1356 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1357 */     this.mask = this.n - 1;
/* 1358 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1359 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1362 */     for (int i = this.size; i-- != 0; ) {
/* 1363 */       int pos; K k = (K)s.readObject();
/* 1364 */       V v = (V)s.readObject();
/* 1365 */       if (k == null) {
/* 1366 */         pos = this.n;
/* 1367 */         this.containsNullKey = true;
/*      */       } else {
/* 1369 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1370 */         for (; key[pos] != null; pos = pos + 1 & this.mask);
/*      */       } 
/* 1372 */       key[pos] = k;
/* 1373 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\objects\Object2ObjectOpenHashMap.class
