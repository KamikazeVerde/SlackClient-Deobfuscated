...
/* 405 */     if (a == null) {
/* 406 */       a = (K[])new Object[this.size];
/* 407 */     } else if (a.length < this.size) {
/* 408 */       a = (K[])Array.newInstance(a.getClass().getComponentType(), this.size);
/*     */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\objects\ObjectArraySet.class
