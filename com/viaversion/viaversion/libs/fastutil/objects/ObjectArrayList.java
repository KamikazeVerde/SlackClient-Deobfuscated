...
/*  804 */     if (a == null) {
/*  805 */       a = (K[])new Object[size()];
/*  806 */     } else if (a.length < size()) {
/*  807 */       a = (K[])Array.newInstance(a.getClass().getComponentType(), size());
/*      */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\objects\ObjectArrayList.class
