...
/* 1086 */       if (Int2IntOpenHashMap.this.containsNullKey) consumer.accept(new AbstractInt2IntMap.BasicEntry(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n], Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n])); 
/* 1087 */       for (int pos = Int2IntOpenHashMap.this.n; pos-- != 0;) { if (Int2IntOpenHashMap.this.key[pos] != 0) consumer.accept(new AbstractInt2IntMap.BasicEntry(Int2IntOpenHashMap.this.key[pos], Int2IntOpenHashMap.this.value[pos]));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2IntMap.Entry> consumer) {
/* 1093 */       AbstractInt2IntMap.BasicEntry entry = new AbstractInt2IntMap.BasicEntry();
/* 1094 */       if (Int2IntOpenHashMap.this.containsNullKey) {
/* 1095 */         entry.key = Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n];
/* 1096 */         entry.value = Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n];
/* 1097 */         consumer.accept(entry);
/*      */       } 
/* 1099 */       for (int pos = Int2IntOpenHashMap.this.n; pos-- != 0;) { if (Int2IntOpenHashMap.this.key[pos] != 0) {
/* 1100 */           entry.key = Int2IntOpenHashMap.this.key[pos];
/* 1101 */           entry.value = Int2IntOpenHashMap.this.value[pos];
...
/* 1131 */       action.accept(Int2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1136 */       return Int2IntOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     public int characteristics() {
/* 1152 */       return this.hasSplit ? 257 : 321;
/*      */     }
/*      */ 
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1157 */       action.accept(Int2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1169 */       return new Int2IntOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1174 */       return new Int2IntOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1180 */       if (Int2IntOpenHashMap.this.containsNullKey) consumer.accept(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n]); 
/* 1181 */       for (int pos = Int2IntOpenHashMap.this.n; pos-- != 0; ) {
/* 1182 */         int k = Int2IntOpenHashMap.this.key[pos];
/* 1183 */         if (k != 0) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1189 */       return Int2IntOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1194 */       return Int2IntOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1199 */       int oldSize = Int2IntOpenHashMap.this.size;
/* 1200 */       Int2IntOpenHashMap.this.remove(k);
/* 1201 */       return (Int2IntOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1206 */       Int2IntOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*      */   {
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1234 */       action.accept(Int2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1239 */       return Int2IntOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1260 */       action.accept(Int2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1271 */     if (this.values == null) this.values = new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1274 */             return new Int2IntOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1279 */             return new Int2IntOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1285 */             if (Int2IntOpenHashMap.this.containsNullKey) consumer.accept(Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n]); 
/* 1286 */             for (int pos = Int2IntOpenHashMap.this.n; pos-- != 0;) { if (Int2IntOpenHashMap.this.key[pos] != 0) consumer.accept(Int2IntOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1291 */             return Int2IntOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1296 */             return Int2IntOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1301 */             Int2IntOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1365 */     int[] key = this.key;
/* 1366 */     int[] value = this.value;
/* 1367 */     int mask = newN - 1;
/* 1368 */     int[] newKey = new int[newN + 1];
/* 1369 */     int[] newValue = new int[newN + 1];
/* 1370 */     int i = this.n;
/* 1371 */     for (int j = realSize(); j-- != 0; ) {
/* 1372 */       while (key[--i] == 0); int pos;
/* 1373 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0) while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1399 */       c = (Int2IntOpenHashMap)super.clone();
...
/* 1407 */     c.key = (int[])this.key.clone();
/* 1408 */     c.value = (int[])this.value.clone();
/* 1409 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1450 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1451 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1452 */     this.mask = this.n - 1;
/* 1453 */     int[] key = this.key = new int[this.n + 1];
/* 1454 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1457 */     for (int i = this.size; i-- != 0; ) {
/* 1458 */       int pos, k = s.readInt();
/* 1459 */       int v = s.readInt();
/* 1460 */       if (k == 0) {
/* 1461 */         pos = this.n;
/* 1462 */         this.containsNullKey = true;
/*      */       } else {
/* 1464 */         pos = HashCommon.mix(k) & this.mask;
/* 1465 */         for (; key[pos] != 0; pos = pos + 1 & this.mask);
/*      */       } 
/* 1467 */       key[pos] = k;
/* 1468 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\ints\Int2IntOpenHashMap.class
