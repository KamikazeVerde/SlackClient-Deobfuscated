...
/* 1017 */       if (Int2ObjectOpenHashMap.this.containsNullKey) consumer.accept(new AbstractInt2ObjectMap.BasicEntry<>(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n], Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n])); 
/* 1018 */       for (int pos = Int2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Int2ObjectOpenHashMap.this.key[pos] != 0) consumer.accept(new AbstractInt2ObjectMap.BasicEntry<>(Int2ObjectOpenHashMap.this.key[pos], Int2ObjectOpenHashMap.this.value[pos]));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
/* 1024 */       AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry<>();
/* 1025 */       if (Int2ObjectOpenHashMap.this.containsNullKey) {
/* 1026 */         entry.key = Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n];
/* 1027 */         entry.value = Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n];
/* 1028 */         consumer.accept(entry);
/*      */       } 
/* 1030 */       for (int pos = Int2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Int2ObjectOpenHashMap.this.key[pos] != 0) {
/* 1031 */           entry.key = Int2ObjectOpenHashMap.this.key[pos];
/* 1032 */           entry.value = Int2ObjectOpenHashMap.this.value[pos];
/* 1033 */           consumer.accept(entry);
/*      */         }  }
/*      */     
/*      */     }
/*      */   }
...
/* 1040 */     if (this.entries == null) this.entries = new MapEntrySet(); 
...
/* 1062 */       action.accept(Int2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1067 */       return Int2ObjectOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1078 */       super(pos, max, mustReturnNull, hasSplit);
/*      */     }
/*      */ 
/*      */     
/*      */     public int characteristics() {
/* 1083 */       return this.hasSplit ? 257 : 321;
/*      */     }
/*      */ 
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1088 */       action.accept(Int2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     final KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
/* 1093 */       return new KeySpliterator(pos, max, mustReturnNull, true);
/*      */     } }
/*      */   
...
/* 1100 */       return new Int2ObjectOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1105 */       return new Int2ObjectOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1111 */       if (Int2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n]); 
/* 1112 */       for (int pos = Int2ObjectOpenHashMap.this.n; pos-- != 0; ) {
/* 1113 */         int k = Int2ObjectOpenHashMap.this.key[pos];
/* 1114 */         if (k != 0) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1120 */       return Int2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1125 */       return Int2ObjectOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1130 */       int oldSize = Int2ObjectOpenHashMap.this.size;
/* 1131 */       Int2ObjectOpenHashMap.this.remove(k);
/* 1132 */       return (Int2ObjectOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1137 */       Int2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public IntSet keySet() {
/* 1143 */     if (this.keys == null) this.keys = new KeySet(); 
/* 1144 */     return this.keys;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1165 */       action.accept(Int2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1170 */       return Int2ObjectOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1181 */       super(pos, max, mustReturnNull, hasSplit);
/*      */     }
/*      */ 
/*      */     
/*      */     public int characteristics() {
/* 1186 */       return this.hasSplit ? 0 : 64;
/*      */     }
/*      */ 
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1191 */       action.accept(Int2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     final ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
/* 1196 */       return new ValueSpliterator(pos, max, mustReturnNull, true);
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1202 */     if (this.values == null) this.values = (ObjectCollection<V>)new AbstractObjectCollection<V>()
/*      */         {
/*      */           public ObjectIterator<V> iterator() {
/* 1205 */             return new Int2ObjectOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1210 */             return new Int2ObjectOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1216 */             if (Int2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n]); 
/* 1217 */             for (int pos = Int2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Int2ObjectOpenHashMap.this.key[pos] != 0) consumer.accept(Int2ObjectOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1222 */             return Int2ObjectOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1227 */             return Int2ObjectOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1232 */             Int2ObjectOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
/* 1235 */     return this.values;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1274 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1275 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f)) return true; 
/*      */     try {
/* 1277 */       rehash(l);
/* 1278 */     } catch (OutOfMemoryError cantDoIt) {
/* 1279 */       return false;
/*      */     } 
/* 1281 */     return true;
/*      */   }
...
/* 1296 */     int[] key = this.key;
/* 1297 */     V[] value = this.value;
/* 1298 */     int mask = newN - 1;
/* 1299 */     int[] newKey = new int[newN + 1];
/* 1300 */     V[] newValue = (V[])new Object[newN + 1];
/* 1301 */     int i = this.n;
/* 1302 */     for (int j = realSize(); j-- != 0; ) {
/* 1303 */       while (key[--i] == 0); int pos;
/* 1304 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0) while (newKey[pos = pos + 1 & mask] != 0); 
/* 1305 */       newKey[pos] = key[i];
/* 1306 */       newValue[pos] = value[i];
/*      */     } 
/* 1308 */     newValue[newN] = value[this.n];
/* 1309 */     this.n = newN;
/* 1310 */     this.mask = mask;
/* 1311 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1312 */     this.key = newKey;
/* 1313 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1330 */       c = (Int2ObjectOpenHashMap<V>)super.clone();
/* 1331 */     } catch (CloneNotSupportedException cantHappen) {
/* 1332 */       throw new InternalError();
/*      */     } 
/* 1334 */     c.keys = null;
/* 1335 */     c.values = null;
/* 1336 */     c.entries = null;
/* 1337 */     c.containsNullKey = this.containsNullKey;
/* 1338 */     c.key = (int[])this.key.clone();
/* 1339 */     c.value = (V[])this.value.clone();
/* 1340 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1354 */     int h = 0;
/* 1355 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1356 */       for (; this.key[i] == 0; i++);
/* 1357 */       t = this.key[i];
/* 1358 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1359 */       h += t;
/* 1360 */       i++;
/*      */     } 
/*      */     
/* 1363 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1364 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1368 */     int[] key = this.key;
/* 1369 */     V[] value = this.value;
/* 1370 */     EntryIterator i = new EntryIterator();
/* 1371 */     s.defaultWriteObject();
/* 1372 */     for (int j = this.size; j-- != 0; ) {
/* 1373 */       int e = i.nextEntry();
/* 1374 */       s.writeInt(key[e]);
/* 1375 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */ 
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1381 */     s.defaultReadObject();
/* 1382 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1383 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1384 */     this.mask = this.n - 1;
/* 1385 */     int[] key = this.key = new int[this.n + 1];
/* 1386 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1389 */     for (int i = this.size; i-- != 0; ) {
/* 1390 */       int pos, k = s.readInt();
/* 1391 */       V v = (V)s.readObject();
/* 1392 */       if (k == 0) {
/* 1393 */         pos = this.n;
/* 1394 */         this.containsNullKey = true;
/*      */       } else {
/* 1396 */         pos = HashCommon.mix(k) & this.mask;
/* 1397 */         for (; key[pos] != 0; pos = pos + 1 & this.mask);
/*      */       } 
/* 1399 */       key[pos] = k;
/* 1400 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\ints\Int2ObjectOpenHashMap.class
