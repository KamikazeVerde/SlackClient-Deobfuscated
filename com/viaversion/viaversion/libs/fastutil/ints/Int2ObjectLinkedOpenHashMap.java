...
/* 1509 */         consumer.accept(new AbstractInt2ObjectMap.BasicEntry<>(Int2ObjectLinkedOpenHashMap.this.key[curr], Int2ObjectLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry<>();
/* 1517 */       for (int i = Int2ObjectLinkedOpenHashMap.this.size, next = Int2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         int curr = next;
/* 1519 */         next = (int)Int2ObjectLinkedOpenHashMap.this.link[curr];
/* 1520 */         entry.key = Int2ObjectLinkedOpenHashMap.this.key[curr];
/* 1521 */         entry.value = Int2ObjectLinkedOpenHashMap.this.value[curr];
/* 1522 */         consumer.accept(entry);
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/* 1529 */     if (this.entries == null) this.entries = new MapEntrySet(); 
/* 1530 */     return this.entries;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1548 */       return Int2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1560 */       action.accept(Int2ObjectLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1565 */       return Int2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1574 */       return new Int2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public IntListIterator iterator() {
/* 1579 */       return new Int2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1589 */       return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2ObjectLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1595 */       for (int i = Int2ObjectLinkedOpenHashMap.this.size, next = Int2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1596 */         int curr = next;
/* 1597 */         next = (int)Int2ObjectLinkedOpenHashMap.this.link[curr];
/* 1598 */         consumer.accept(Int2ObjectLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1604 */       return Int2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1609 */       return Int2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1614 */       int oldSize = Int2ObjectLinkedOpenHashMap.this.size;
/* 1615 */       Int2ObjectLinkedOpenHashMap.this.remove(k);
/* 1616 */       return (Int2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1621 */       Int2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstInt() {
/* 1626 */       if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1627 */       return Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public int lastInt() {
/* 1632 */       if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1633 */       return Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public IntComparator comparator() {
...
/* 1659 */     if (this.keys == null) this.keys = new KeySet(); 
/* 1660 */     return this.keys;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*      */     public V previous() {
/* 1674 */       return Int2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1686 */       action.accept(Int2ObjectLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1691 */       return Int2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1697 */     if (this.values == null) this.values = (ObjectCollection<V>)new AbstractObjectCollection<V>()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 80;
/*      */           
/*      */           public ObjectIterator<V> iterator() {
/* 1702 */             return (ObjectIterator<V>)new Int2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1712 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2ObjectLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1718 */             for (int i = Int2ObjectLinkedOpenHashMap.this.size, next = Int2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1719 */               int curr = next;
/* 1720 */               next = (int)Int2ObjectLinkedOpenHashMap.this.link[curr];
/* 1721 */               consumer.accept(Int2ObjectLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1727 */             return Int2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1732 */             return Int2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1737 */             Int2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
/* 1740 */     return this.values;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1779 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1780 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f)) return true; 
/*      */     try {
/* 1782 */       rehash(l);
...
/* 1801 */     int[] key = this.key;
/* 1802 */     V[] value = this.value;
/* 1803 */     int mask = newN - 1;
/* 1804 */     int[] newKey = new int[newN + 1];
/* 1805 */     V[] newValue = (V[])new Object[newN + 1];
...
/* 1811 */       int pos; if (key[i] == 0) { pos = newN; }
/*      */       else
/* 1813 */       { pos = HashCommon.mix(key[i]) & mask;
/* 1814 */         for (; newKey[pos] != 0; pos = pos + 1 & mask); }
/*      */       
...
/*      */     try {
/* 1857 */       c = (Int2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1865 */     c.key = (int[])this.key.clone();
/* 1866 */     c.value = (V[])this.value.clone();
...
/* 1884 */       for (; this.key[i] == 0; i++);
/* 1885 */       t = this.key[i];
/* 1886 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1887 */       h += t;
/* 1888 */       i++;
/*      */     } 
/*      */     
/* 1891 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1892 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1896 */     int[] key = this.key;
/* 1897 */     V[] value = this.value;
/* 1898 */     EntryIterator i = new EntryIterator();
/* 1899 */     s.defaultWriteObject();
/* 1900 */     for (int j = this.size; j-- != 0; ) {
/* 1901 */       int e = i.nextEntry();
/* 1902 */       s.writeInt(key[e]);
/* 1903 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/* 1913 */     int[] key = this.key = new int[this.n + 1];
/* 1914 */     V[] value = this.value = (V[])new Object[this.n + 1];
...
/* 1921 */       int pos, k = s.readInt();
/* 1922 */       V v = (V)s.readObject();
/* 1923 */       if (k == 0) {
/* 1924 */         pos = this.n;
/* 1925 */         this.containsNullKey = true;
/*      */       } else {
/* 1927 */         pos = HashCommon.mix(k) & this.mask;
/* 1928 */         for (; key[pos] != 0; pos = pos + 1 & this.mask);
/*      */       } 
/* 1930 */       key[pos] = k;
/* 1931 */       value[pos] = v;
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viaversion\libs\fastutil\ints\Int2ObjectLinkedOpenHashMap.class
