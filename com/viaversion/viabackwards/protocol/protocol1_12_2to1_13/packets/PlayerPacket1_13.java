...
/*     */           }
/*     */         });
/* 218 */     ((Protocol1_12_2To1_13)this.protocol).registerClientbound((ClientboundPacketType)ClientboundPackets1_13.TEAMS, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/* 221 */             map(Type.STRING);
/* 222 */             map((Type)Type.BYTE);
/* 223 */             handler(wrapper -> {
...
/* 248 */                       prefix = prefix + "§" + ((colour > -1 && colour <= 15) ? Integer.toHexString(colour) : "r");
/*     */                     }
...
/*     */           }
/*     */         });
/* 277 */     ((Protocol1_12_2To1_13)this.protocol).registerClientbound((ClientboundPacketType)ClientboundPackets1_13.DECLARE_COMMANDS, null, wrapper -> {
/*     */           wrapper.cancel();
/*     */           
...
/*     */           } 
/*     */         });
/* 317 */     ((Protocol1_12_2To1_13)this.protocol).registerClientbound((ClientboundPacketType)ClientboundPackets1_13.TAB_COMPLETE, wrapper -> {
/*     */           TabCompleteStorage storage = (TabCompleteStorage)wrapper.user().get(TabCompleteStorage.class);
...
/* 336 */             wrapper.write(Type.STRING, ((start == 0 && !storage.isLastAssumeCommand()) ? "/" : "") + match);
/*     */ 
/*     */             
...
/*     */         });
/*     */     
/* 345 */     ((Protocol1_12_2To1_13)this.protocol).registerServerbound((ServerboundPacketType)ServerboundPackets1_12_1.TAB_COMPLETE, wrapper -> {
/*     */           TabCompleteStorage storage = (TabCompleteStorage)wrapper.user().get(TabCompleteStorage.class);
/*     */           
...
/*     */         });
/* 395 */     ((Protocol1_12_2To1_13)this.protocol).registerServerbound((ServerboundPacketType)ServerboundPackets1_12_1.PLUGIN_MESSAGE, wrapper -> {
/*     */           Item book;
/*     */           boolean signing;
/*     */           byte type;
/*     */           int x;
...
/*     */           } 
/*     */         });
/* 542 */     ((Protocol1_12_2To1_13)this.protocol).registerClientbound((ClientboundPacketType)ClientboundPackets1_13.STATISTICS, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/* 545 */             map((Type)Type.VAR_INT);
/* 546 */             handler(wrapper -> {
...
/* 590 */     if (string.length() < prefix.length()) {
/* 591 */       return false;
/*     */     }
/* 593 */     return string.regionMatches(true, 0, prefix, 0, prefix.length());
/*     */   }
/*     */ }


/* Location:              C:\Users\andre\Downloads\Slack.jar!\com\viaversion\viabackwards\protocol\protocol1_12_2to1_13\packets\PlayerPacket1_13.class
