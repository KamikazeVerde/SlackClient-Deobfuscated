...
/*  26 */     protocol.registerClientbound((ClientboundPacketType)ClientboundPackets1_8.SCOREBOARD_OBJECTIVE, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/*  29 */             handler(packetWrapper -> {
...
/*     */           }
/*     */         });
/*  84 */     protocol.registerClientbound((ClientboundPacketType)ClientboundPackets1_8.UPDATE_SCORE, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/*  87 */             map(Type.STRING);
/*  88 */             map((Type)Type.VAR_INT, (Type)Type.BYTE);
/*  89 */             handler(packetWrapper -> {
/*     */                   Scoreboard scoreboard = (Scoreboard)packetWrapper.user().get(Scoreboard.class);
/*     */                   
...
/*     */           }
/*     */         });
/* 122 */     protocol.registerClientbound((ClientboundPacketType)ClientboundPackets1_8.DISPLAY_SCOREBOARD, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/* 125 */             map((Type)Type.BYTE);
/* 126 */             map(Type.STRING);
/* 127 */             handler(packetWrapper -> {
...
/*     */           }
/*     */         });
/* 159 */     protocol.registerClientbound((ClientboundPacketType)ClientboundPackets1_8.TEAMS, (PacketHandler)new PacketHandlers()
/*     */         {
/*     */           public void register() {
/* 162 */             map(Type.STRING);
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\de\gerrygames\viarewind\protocol\protocol1_7_6_10to1_8\packets\ScoreboardPackets.class
