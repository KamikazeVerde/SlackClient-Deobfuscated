...
/*  77 */       if (metadata.id() == 16 || metadata.id() == 17)
/*  78 */         continue;  metadataList.add(new Metadata(metadata.id(), metadata.metaType(), metadata.getValue()));
/*     */     } 
/*     */     
/*  81 */     MetadataRewriter.transform(Entity1_10Types.EntityType.SQUID, metadataList);
/*     */     
/*  83 */     metadataPacket.write(Types1_7_6_10.METADATA_LIST, metadataList);
/*     */     
/*  85 */     PacketUtil.sendPacket(metadataPacket, Protocol1_7_6_10TO1_8.class);
/*     */   }
/*     */ 
/*     */   
/*     */   public void spawn() {
/*  90 */     sendSpawn(this.entityId, 94, this.locX, this.locY, this.locZ);
/*     */   }
/*     */ 
/*     */   
/*     */   public void despawn() {
/*  95 */     PacketWrapper despawn = PacketWrapper.create((PacketType)ClientboundPackets1_7.DESTROY_ENTITIES, null, this.user);
/*  96 */     despawn.write(Types1_7_6_10.INT_ARRAY, new int[] { this.entityId });
/*     */     
/*  98 */     PacketUtil.sendPacket(despawn, Protocol1_7_6_10TO1_8.class, true, true);
/*     */   }
/*     */   
...
/* Location:              C:\Users\andre\Downloads\Slack.jar!\de\gerrygames\viarewind\protocol\protocol1_7_6_10to1_8\entityreplacements\GuardianReplacement.class
